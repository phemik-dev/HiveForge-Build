...
| --- | --- | --- | --- |
| `@hiveforge-ai/cosmokit` | `cosmokit` | [github.com/hiveforge-harness/cosmokit](https://github.com/hiveforge-harness/cosmokit) | MIT |
| `@hiveforge-ai/schemastery` | `schemastery` | [github.com/hiveforge-harness/schemastery](https://github.com/hiveforge-harness/schemastery) | MIT |
| `@hiveforge-ai/cordis` | `cordis` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@hiveforge-ai/cordis-plugin-loader` | `@cordisjs/plugin-loader` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@hiveforge-ai/cordis-plugin-include` | `@cordisjs/plugin-include` | [github.com/hiveforge-harness/cordis](https://github.com/hiveforge-harness/cordis) | MIT |
| `@hiveforge-ai/cordis-plugin-group` | `@cordisjs/plugin-group` | [github.com/hiveforge-harness/cordis](https://github.com/hiveforge-harness/cordis) | MIT |
| `@hiveforge-ai/cordis-plugin-timer` | `@cordisjs/plugin-timer` | [github.com/hiveforge-harness/cordis](https://github.com/hiveforge-harness/cordis) | MIT |
| `@hiveforge-ai/cordis-plugin-hmr` | `@cordisjs/plugin-hmr` | [github.com/hiveforge-harness/cordis](https://github.com/hiveforge-harness/cordis) | MIT |
| `@hiveforge-ai/cordis-plugin-logger-console` | `@cordisjs/plugin-logger-console` | [github.com/hiveforge-harness/cordis](https://github.com/hiveforge-harness/cordis) | MIT |
...
`eslint-plugin-sonarjs` (LGPL-3.0-only) and `lightningcss` (MPL-2.0) run only as development tooling; their code is not linked into or distributed with any HiveForge Harness artifact.
...
| [`pydantic`](https://github.com/pydantic/pydantic) | MIT | runtime dependency of `hiveforge-harness-sdk` |
