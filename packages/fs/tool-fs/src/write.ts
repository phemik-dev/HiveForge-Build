 ...
 * @module @hiveforge-ai/dsh-tool-fs/src/write
 */

import type { Context } from '@hiveforge-ai/cordis'
import { defineTool } from '@hiveforge-ai/dsh-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@hiveforge-ai/dsh-tools'
import type { FsWriteOutcome } from '@hiveforge-ai/dsh-fs'
