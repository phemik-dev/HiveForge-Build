 ...
 * @module @hiveforge-ai/dsh-tool-fs/src/read-image
 */

import { basename, extname } from 'node:path'
import type { Context } from '@hiveforge-ai/cordis'
import { AttachmentError, AttachmentId } from '@hiveforge-ai/dsh-attachment'
import type { ImageAttachmentRef, ImageMediaType } from '@hiveforge-ai/dsh-attachment'
import type { ContentBlock } from '@hiveforge-ai/dsh-llm'
import { defineTool } from '@hiveforge-ai/dsh-tools'
import type { GenericCallView, ToolExecution } from '@hiveforge-ai/dsh-tools'
import type {} from '@hiveforge-ai/dsh-fs'
