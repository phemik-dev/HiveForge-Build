 ...
 * `@hiveforge-ai/dsh-fs` Service Definition. It extends `LocalFileSystem` so all
 ...
 * stays `ctx.shell`'s job (`@hiveforge-ai/dsh-bash-sandbox`). This mirrors the
 ...
 * escalation retry lives in the tool layer (`@hiveforge-ai/dsh-tool-fs`),
 * exactly as bash's does.
 *
 * @module @hiveforge-ai/dsh-fs-sandbox
 */

import { Context } from '@hiveforge-ai/cordis'
import { LocalFileSystem } from '@hiveforge-ai/dsh-fs-local'
import type { Config as LocalConfig } from '@hiveforge-ai/dsh-fs-local'
import { FsError } from '@hiveforge-ai/dsh-fs'
import type { FsEditOutcome, FsEditRequest, FsTarget, FsVersion, FsWriteIntent, FsWriteOutcome } from '@hiveforge-ai/dsh-fs'
import { writableRoots } from '@hiveforge-ai/dsh-sandbox'
