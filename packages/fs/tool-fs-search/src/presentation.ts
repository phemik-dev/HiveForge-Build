 ...
 * model-facing render consumes ({@link module:@hiveforge-ai/dsh-tool-fs-search/search-core}
 ...
 *
 * @module @hiveforge-ai/dsh-tool-fs-search/presentation
 */
 ...
 * ({@link module:@hiveforge-ai/dsh-tool-fs-search/grep} `formatGrepMatches`), so
