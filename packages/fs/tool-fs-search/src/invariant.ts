/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-tool-fs-search`.
 * @module @hiveforge-ai/dsh-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-tool-fs-search'
