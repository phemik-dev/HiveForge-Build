 ...
 *
 * @module @hiveforge-ai/dsh-tool-fs-search/grep
 */

import type { Context } from '@hiveforge-ai/cordis'
import { defineTool } from '@hiveforge-ai/dsh-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@hiveforge-ai/dsh-tools'
import type { RetainedItems } from '@hiveforge-ai/dsh-output-retention'
import type { SpillRef } from '@hiveforge-ai/dsh-spill'
