/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-tool-str-replace-editor`.
 * @module @hiveforge-ai/dsh-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-tool-str-replace-editor'
