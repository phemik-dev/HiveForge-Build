 ...
 * ```
 *
 * The inherited environment wins because `HIVEFORGE_API_KEY=… dsh`, a CI
 ...
 * @module @hiveforge-ai/dsh-credentials-local
 */
...
import { CredentialProvider, credentialRef, parseCredentialKey } from '@hiveforge-ai/dsh-credentials'
import type {
  ApiKeyRecord,
  CredentialInfo,
  CredentialKey,
...
import type { LaunchEnvironmentEntry } from '@hiveforge-ai/dsh-launch-environment'
