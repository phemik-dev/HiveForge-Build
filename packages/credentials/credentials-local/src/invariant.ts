/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-credentials-local`.
 * @module @hiveforge-ai/dsh-credentials-local/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-credentials-local'
