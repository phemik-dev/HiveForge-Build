...
import { credentialKey, credentialRef } from '@hiveforge-ai/dsh-credentials'

declare const ctx: Context

const ref = credentialRef('HIVEFORGE_API_KEY')            // POSIX shell identifier, branded
