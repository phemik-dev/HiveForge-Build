/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-credentials`.
 * @module @hiveforge-ai/dsh-credentials/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-credentials'
