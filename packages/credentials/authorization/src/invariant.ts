/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-authorization`.
 * @module @hiveforge-ai/dsh-authorization/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-authorization'
