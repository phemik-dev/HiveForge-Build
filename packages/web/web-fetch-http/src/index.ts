/**
 * `@hiveforge-ai/dsh-web-fetch-http`: registers an anonymous public HTTP(S)
 ...
 *
 * @module @hiveforge-ai/dsh-web-fetch-http
 */
...
export const DEFAULT_USER_AGENT = 'hiveforge-harness/0.0.1 (+https://github.com/hiveforge-ai)'
