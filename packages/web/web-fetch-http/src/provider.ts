 ...
 * `@hiveforge-ai/dsh-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @hiveforge-ai/dsh-web-fetch-http/provider
 */

import { WebError } from '@hiveforge-ai/dsh-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@hiveforge-ai/dsh-web'
