/**
 * Provider-private wire types for HiveForge's Anthropic-compatible Messages API. Citeable
 ...
 * @module @hiveforge-ai/dsh-web-search-hiveforge/types
 */
...
/** HiveForge's Anthropic Messages response envelope. */
export interface AnthropicResponse {
  content?: ContentBlock[]
}

/** HiveForge's error response envelope (best-effort; fields vary). */
