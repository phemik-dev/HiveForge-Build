...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@hiveforge-ai/dsh-tools'
import type { WebFetchBody, WebFetchResult } from '@hiveforge-ai/dsh-web'
 ...
 * `@hiveforge-ai/dsh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@hiveforge-ai/dsh-tool-call-timeout-policy` to enforce.
