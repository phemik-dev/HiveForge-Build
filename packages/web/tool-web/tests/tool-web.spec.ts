...
import type { WebSearchProvider, WebSearchResult } from '@hiveforge-ai/dsh-web'
...
} from '@hiveforge-ai/dsh-tool-web'
import type { ContentBlock } from '@hiveforge-ai/dsh-llm'
import type { ToolResult } from '@hiveforge-ai/dsh-tools'
...
async function mountTools(opts: {
  ...
  fetchProvider?: import('@hiveforge-ai/dsh-web').WebFetchProvider
