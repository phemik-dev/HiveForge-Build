/**
 * `@hiveforge-ai/dsh-web-search-perplexity`: registers a Perplexity-backed
 * `WebSearchProvider` with `ctx.web`. A function/namespace plugin (NOT a
 * default-export service): it registers INTO the seam's provider registry, like
 * `@hiveforge-ai/dsh-llm-hiveforge` registers an adapter into `ctx.llm`.
 *
 * @module @hiveforge-ai/dsh-web-search-perplexity
 */
