/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-command-feedback`.
 * @module @hiveforge-ai/dsh-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-command-feedback'
