...
import type { SaveTextSpill } from '@hiveforge-ai/dsh-spill'
import LocalSpillStore, { encodeSegment, privateRoot, saveTextFile, sessionDir } from '@hiveforge-ai/dsh-spill-local'
