/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-llm-mock-server`.
 * @module @hiveforge-ai/dsh-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-llm-mock-server'
