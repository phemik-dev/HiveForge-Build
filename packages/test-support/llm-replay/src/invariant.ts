/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-llm-replay`.
 * @module @hiveforge-ai/dsh-llm-replay/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-llm-replay'
