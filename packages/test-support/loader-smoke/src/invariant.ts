/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-loader-smoke`.
 * @module @hiveforge-ai/dsh-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-loader-smoke'
