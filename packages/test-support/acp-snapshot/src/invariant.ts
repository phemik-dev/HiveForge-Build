/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-acp-snapshot`.
 * @module @hiveforge-ai/dsh-acp-snapshot/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-acp-snapshot'
