/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-test-runtime`.
 * @module @hiveforge-ai/dsh-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-test-runtime'
