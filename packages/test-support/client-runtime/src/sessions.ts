...
import type { AttachmentIdType } from '@hiveforge-ai/dsh-attachment'
import { createScope, scopeOf, SessionProvideChannel } from '@hiveforge-ai/dsh-client-runtime/client'
...
import type { HostObservable, SessionMaybeProvideInfo, SessionProvideInfo } from '@hiveforge-ai/dsh-client-ui-slots'
