 ...
 * @module @hiveforge-ai/dsh-tool-terminal
 */
...
import { TerminalSessionId } from '@hiveforge-ai/dsh-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@hiveforge-ai/dsh-terminal'
import type {} from '@hiveforge-ai/dsh-jobs'
import { defineTool } from '@hiveforge-ai/dsh-tools'
import type { ToolDefinition } from '@hiveforge-ai/dsh-tools'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @hiveforge-ai/dsh-jobs and @hiveforge-ai/dsh-tool-jobs')
