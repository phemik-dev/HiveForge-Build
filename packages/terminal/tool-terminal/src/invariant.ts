/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-tool-terminal`.
 * @module @hiveforge-ai/dsh-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-tool-terminal'
