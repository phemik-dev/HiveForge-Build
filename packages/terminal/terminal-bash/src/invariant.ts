/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-terminal-bash`.
 * @module @hiveforge-ai/dsh-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-terminal-bash'
