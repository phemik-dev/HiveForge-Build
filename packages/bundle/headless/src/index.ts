/**
 * @hiveforge-ai/dsh-headless — one-shot direct Agent driver. The bundle patch
 ...
 *
 * @module @hiveforge-ai/dsh-headless
 */
...
import type { ModelSelectionRef } from '@hiveforge-ai/dsh-agent'
import type {} from '@hiveforge-ai/dsh-agent-default-model'
...
import type {} from '@hiveforge-ai/dsh-cmdline'
