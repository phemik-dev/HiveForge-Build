 ...
 * @module @hiveforge-ai/dsh-agent-presets/mount
 */
...
import type { EntryTree } from '@hiveforge-ai/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@hiveforge-ai/dsh-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@hiveforge-ai/dsh-*` row would fail to import. The
