 ...
 * @module @hiveforge-ai/dsh-agent-presets
 */

import { stat } from 'node:fs/promises'
import { Context, Service } from '@hiveforge-ai/cordis'
import z from '@hiveforge-ai/schemastery'
import { bindScopeParent, createScope, scopeOf, type Scope, type ScopeKey, type ScopeParentBinding } from '@hiveforge-ai/dsh-scope'
// Type-only: resolves the `agent/created` lifecycle event this service watches.
import type {} from '@hiveforge-ai/dsh-agent'
import { settingsNamespace, type SettingsScope, type default as SettingsService } from '@hiveforge-ai/dsh-settings'
