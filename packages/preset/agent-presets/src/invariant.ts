/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-agent-presets`.
 * @module @hiveforge-ai/dsh-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@hiveforge-ai/dsh-agent-presets'

const PACKAGE_NAME = '@hiveforge-ai/dsh-agent-presets'
