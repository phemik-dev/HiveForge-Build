...
import { agentEvents } from '@hiveforge-ai/dsh-agent'
import { TOOL_ORDER_REST } from '@hiveforge-ai/dsh-system-prompt'
...
/**
 * In-process unit coverage for the @hiveforge-ai/dsh-acp-demo composition:
