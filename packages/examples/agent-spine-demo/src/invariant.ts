/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-agent-spine-demo`.
 * @module @hiveforge-ai/dsh-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-agent-spine-demo'
