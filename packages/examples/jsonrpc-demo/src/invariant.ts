/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-sdk-jsonrpc-demo`.
 * @module @hiveforge-ai/dsh-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-sdk-jsonrpc-demo'
