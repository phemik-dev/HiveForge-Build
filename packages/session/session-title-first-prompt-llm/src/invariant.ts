/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-session-title-first-prompt-llm`.
 * @module @hiveforge-ai/dsh-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-session-title-first-prompt-llm'
