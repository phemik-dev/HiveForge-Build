/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-session-checkpoint-policy`.
 * @module @hiveforge-ai/dsh-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-session-checkpoint-policy'
