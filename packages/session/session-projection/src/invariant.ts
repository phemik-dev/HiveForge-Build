/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-session-projection`.
 * @module @hiveforge-ai/dsh-session-projection/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-session-projection'
