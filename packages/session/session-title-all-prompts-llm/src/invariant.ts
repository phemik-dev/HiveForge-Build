/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-session-title-all-prompts-llm`.
 * @module @hiveforge-ai/dsh-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-session-title-all-prompts-llm'
