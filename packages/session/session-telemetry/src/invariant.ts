/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-session-telemetry`.
 * @module @hiveforge-ai/dsh-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-session-telemetry'
