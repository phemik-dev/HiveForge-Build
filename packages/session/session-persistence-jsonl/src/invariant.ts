/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-session-persistence-jsonl`.
 * @module @hiveforge-ai/dsh-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-session-persistence-jsonl'
