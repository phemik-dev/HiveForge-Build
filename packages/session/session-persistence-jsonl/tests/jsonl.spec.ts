import { MessageId, createUserMessage, createMessage } from '@hiveforge-ai/dsh-llm'
...
import type { Session, SessionEvent, SessionHeader } from '@hiveforge-ai/dsh-session'
...
describe('JsonlSessionPersistence: format helpers', () => {
  ...
  it('projectKey normalizes project paths into bounded readable names', () => {
    expect(projectKey('/Users/qyj/work/hiveforge-harness')).toBe('--Users-qyj-work-hiveforge-harness--')
