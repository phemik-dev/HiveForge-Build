 ...
 * @module @hiveforge-ai/dsh-session-persistence
 */

import { Context, Service } from '@hiveforge-ai/cordis'
import { SessionPreparation } from '@hiveforge-ai/dsh-session'
import type { SessionEvent, SessionId, SessionHeader } from '@hiveforge-ai/dsh-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@hiveforge-ai/dsh-session'
