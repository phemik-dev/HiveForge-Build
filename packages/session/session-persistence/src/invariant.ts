/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-session-persistence`.
 * @module @hiveforge-ai/dsh-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-session-persistence'
