/**
 * OpenTelemetry Service Provider for the HiveForge Harness telemetry capability.
 *
 ...
 *
 * @module @hiveforge-ai/dsh-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@hiveforge-ai/schemastery'
import type { Context } from '@hiveforge-ai/cordis'
import type {} from '@hiveforge-ai/dsh-command-feedback'
import {
...
} from '@hiveforge-ai/dsh-session-telemetry'
import { APP_IDENTITY } from '@hiveforge-ai/dsh-llm'
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@hiveforge-ai/dsh-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@hiveforge-ai/dsh-session-telemetry-otel/ops', version)
