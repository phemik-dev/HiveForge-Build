/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-session-telemetry-otel`.
 * @module @hiveforge-ai/dsh-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-session-telemetry-otel'
