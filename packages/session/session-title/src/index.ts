 ...
 * @module @hiveforge-ai/dsh-session-title
 */

import { Context, FiberState, Service, type Fiber } from '@hiveforge-ai/cordis'
import z from '@hiveforge-ai/schemastery'
import { z as zod } from 'zod'
import type { Branded } from '@hiveforge-ai/dsh-brand'
import { assertNever, deepFreeze, isAgentLoopRequest } from '@hiveforge-ai/dsh-llm'
import type { GenerateOptions } from '@hiveforge-ai/dsh-llm'
import type {
  Session,
  SessionEvent,
