/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-session-title`.
 * @module @hiveforge-ai/dsh-session-title/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-session-title'
