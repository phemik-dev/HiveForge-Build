/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-session-projection-cache`.
 * @module @hiveforge-ai/dsh-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-session-projection-cache'
