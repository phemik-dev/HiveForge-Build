/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-session-stats`.
 * @module @hiveforge-ai/dsh-session-stats/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-session-stats'
