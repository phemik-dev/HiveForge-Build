/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-session-title-llm`.
 * @module @hiveforge-ai/dsh-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-session-title-llm'
