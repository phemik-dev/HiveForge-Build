/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-session-persistence-sqlite`.
 * @module @hiveforge-ai/dsh-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-session-persistence-sqlite'
