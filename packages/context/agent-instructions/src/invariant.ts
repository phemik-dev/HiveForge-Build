/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-agent-instructions`.
 * @module @hiveforge-ai/dsh-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-agent-instructions'
