 ...
 *
 * @module @hiveforge-ai/dsh-agent-instructions/files
 */

import { createReadStream } from 'node:fs'
import { stat } from 'node:fs/promises'
import { dirname, isAbsolute, join, relative, resolve } from 'node:path'
import type { FileSystem, FsInfo, FsTarget, FsVersion } from '@hiveforge-ai/dsh-fs'
import { assertNever } from '@hiveforge-ai/dsh-llm'
import { dshHomeDisplay } from '@hiveforge-ai/dsh-home-paths'
