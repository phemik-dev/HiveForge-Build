/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-file-reference-local`.
 * @module @hiveforge-ai/dsh-file-reference-local/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-file-reference-local'
