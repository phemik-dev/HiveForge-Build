/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-file-reference`.
 * @module @hiveforge-ai/dsh-file-reference/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-file-reference'
