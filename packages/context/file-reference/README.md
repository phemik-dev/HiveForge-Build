# `@hiveforge-ai/dsh-file-reference`
...
Indirectly, through `@hiveforge-ai/dsh-file-reference-local`, which conditionally contributes this package's stable file-reference guidance.
