/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-tmux-context`.
 * @module @hiveforge-ai/dsh-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-tmux-context'
