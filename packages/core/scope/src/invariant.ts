/** Package-owned scoped-dispatch invariants. @module @hiveforge-ai/dsh-scope/invariant */

import type { Context } from '@hiveforge-ai/cordis'
import type { InvariantInstaller } from '@hiveforge-ai/dsh-invariants'
import { carrierKeyOf, isScopeCarrier } from '@hiveforge-ai/dsh-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@hiveforge-ai/dsh-scope'
