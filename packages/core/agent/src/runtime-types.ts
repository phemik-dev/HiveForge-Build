 ...
 * turn/step boundaries remain `@hiveforge-ai/dsh-session` events.
 *
...
import type { LlmCallConfig, LlmFailure, ResolvedRetryPolicy } from '@hiveforge-ai/dsh-llm'
import type { AgentCancelCause, Session, SessionId, UserMessage } from '@hiveforge-ai/dsh-session'
export type { AgentCancelCause } from '@hiveforge-ai/dsh-session'
import type { Inbox } from './inbox.ts'
import type { InboxTarget } from './types.ts'
import type {} from '@hiveforge-ai/dsh-system-prompt'
declare module '@hiveforge-ai/dsh-system-prompt' {
...
declare module '@hiveforge-ai/cordis' {
  interface Events {
     ...
     * Scope-filtered dispatch (`@hiveforge-ai/dsh-scope`): agent-scoped listeners receive only that agent.
     * @mode emit
     */
