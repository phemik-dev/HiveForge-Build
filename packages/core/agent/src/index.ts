 ...
 *
 * @module @hiveforge-ai/dsh-agent
 */

import { Context, FiberState, getTraceable, Service, symbols } from '@hiveforge-ai/cordis'
...
import type { SessionEvent, SessionId } from '@hiveforge-ai/dsh-session'
import type { TypertContext, TypertLookup } from '@hiveforge-ai/dsh-typert-protocol'
 ...
 * (`@hiveforge-ai/dsh-agent-loop`), registered via {@link setFactory}.
 *
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('agent', {
        parameter: 'agent',
        wire: 'agentId',
        hostTypeSymbol: '@hiveforge-ai/dsh-agent#Agent',
