 ...
 * @module @hiveforge-ai/dsh-agent-loop/runtime-context
 */

import { createUserMessage } from '@hiveforge-ai/dsh-llm'
import type { ContextSnapshotSection } from '@hiveforge-ai/dsh-llm'
import type { Session, UserMessage } from '@hiveforge-ai/dsh-session'
import { isReplacementSurfaceEvent } from '@hiveforge-ai/dsh-session'
import type { Context } from '@hiveforge-ai/cordis'

const SOURCE = '@hiveforge-ai/dsh-system-prompt'
