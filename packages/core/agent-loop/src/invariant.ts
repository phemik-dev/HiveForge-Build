 ...
 * @module @hiveforge-ai/dsh-agent-loop/invariant
 */

import type { Context } from '@hiveforge-ai/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@hiveforge-ai/dsh-llm'
import type { InvariantFailure, InvariantInstaller } from '@hiveforge-ai/dsh-invariants'
import { foldRequestHeader } from '@hiveforge-ai/dsh-session'

const PACKAGE_NAME = '@hiveforge-ai/dsh-agent-loop'
