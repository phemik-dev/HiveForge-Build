 ...
 *
 * @module @hiveforge-ai/dsh-session
 */

import { Context, Service } from '@hiveforge-ai/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@hiveforge-ai/dsh-llm'
import { scopeOf, scopeTarget } from '@hiveforge-ai/dsh-scope'
import type { Scoped } from '@hiveforge-ai/dsh-scope'
import type { Message } from '@hiveforge-ai/dsh-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@hiveforge-ai/dsh-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@hiveforge-ai/dsh-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@hiveforge-ai/dsh-session#Session',
        wireTypeSymbol: '@hiveforge-ai/dsh-session/types#SessionId',
