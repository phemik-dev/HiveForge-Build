 ...
 * whose JSON envelopes dwarf their payloads (~56× measured on a real HiveForge
 ...
 *
 * @module @hiveforge-ai/dsh-session/chunk-rows
 */

import { CallId, assertNever } from '@hiveforge-ai/dsh-llm'
