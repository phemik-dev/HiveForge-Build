/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-agent-tool-presentation`.
 * @module @hiveforge-ai/dsh-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-agent-tool-presentation'
