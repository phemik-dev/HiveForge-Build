/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-storage-sqlite`.
 * @module @hiveforge-ai/dsh-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-storage-sqlite'
