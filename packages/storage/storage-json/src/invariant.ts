/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-storage-json`.
 * @module @hiveforge-ai/dsh-storage-json/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-storage-json'
