/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-storage-domain`: every
 ...
 * @module @hiveforge-ai/dsh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-storage-domain'
