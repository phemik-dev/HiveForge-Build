/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-invariants`.
 * @module @hiveforge-ai/dsh-invariants/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-invariants'
