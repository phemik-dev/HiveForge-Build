/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-typert-registry`.
 * @module @hiveforge-ai/dsh-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-typert-registry'
