/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-typert-loader`.
 * @module @hiveforge-ai/dsh-typert-loader/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-typert-loader'
