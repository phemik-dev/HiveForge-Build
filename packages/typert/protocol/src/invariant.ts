/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-typert-protocol`.
 * @module @hiveforge-ai/dsh-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-typert-protocol'
