/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-typert-generator`.
 * @module @hiveforge-ai/dsh-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-typert-generator'
