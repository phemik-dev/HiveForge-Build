/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-workspace`.
 * @module @hiveforge-ai/dsh-workspace/invariant
 */

import type { Context } from '@hiveforge-ai/cordis'
import type { InvariantInstaller } from '@hiveforge-ai/dsh-invariants'
import type { DomainChanged } from '@hiveforge-ai/dsh-storage-domain'
import { WorkspaceId } from '@hiveforge-ai/dsh-workspace'

const PACKAGE_NAME = '@hiveforge-ai/dsh-workspace'
