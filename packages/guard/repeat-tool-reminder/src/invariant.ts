/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-repeat-tool-reminder`.
 * @module @hiveforge-ai/dsh-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-repeat-tool-reminder'
