/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-tool-call-timeout-policy`.
 * @module @hiveforge-ai/dsh-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-tool-call-timeout-policy'
