/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-sandbox-windows-acl`.
 * @module @hiveforge-ai/dsh-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-sandbox-windows-acl'
