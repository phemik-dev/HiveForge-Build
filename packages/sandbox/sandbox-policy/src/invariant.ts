/** Package-owned session-event invariants for sandbox policy. @module @hiveforge-ai/dsh-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-sandbox-policy'
