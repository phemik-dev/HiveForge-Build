 ...
 *
 * @module @hiveforge-ai/dsh-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@hiveforge-ai/node-addon-landlock-run'
 ...
 * (`@hiveforge-ai/dsh-fs-sandbox`) can never drift apart.
