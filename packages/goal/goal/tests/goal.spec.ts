...
import AgentRegistry, { agentEvents, Inbox } from '@hiveforge-ai/dsh-agent'
import type { Agent } from '@hiveforge-ai/dsh-agent'
import { createUserMessage, HarnessError } from '@hiveforge-ai/dsh-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@hiveforge-ai/dsh-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
  foldGoal,
} from '@hiveforge-ai/dsh-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@hiveforge-ai/dsh-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@hiveforge-ai/dsh-session').SessionEvent[]): StubAgent {
