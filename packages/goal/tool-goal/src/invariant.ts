/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-tool-goal`.
 * @module @hiveforge-ai/dsh-tool-goal/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-tool-goal'
