 ...
 * @module @hiveforge-ai/dsh-tool-goal
 */
...
import type { GoalRef, GoalView } from '@hiveforge-ai/dsh-goal'
import { boundContextSummary, createUserMessage, HarnessError } from '@hiveforge-ai/dsh-llm'
import { defineTool } from '@hiveforge-ai/dsh-tools'
import type { GenericCallView } from '@hiveforge-ai/dsh-tools'
