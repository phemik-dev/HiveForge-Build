/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-command-goal`.
 * @module @hiveforge-ai/dsh-command-goal/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-command-goal'
