/** Package-owned goal-round prompt invariants. @module @hiveforge-ai/dsh-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@hiveforge-ai/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@hiveforge-ai/dsh-goal'
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-goal-round-driver'
