/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-tool-ralph`.
 * @module @hiveforge-ai/dsh-tool-ralph/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-tool-ralph'
