...
import type { SubagentCapabilities, SubagentProvider, SubagentRun, SubagentStartRequest } from '@hiveforge-ai/dsh-subagent'
...
import type { WorkflowResult, WorkflowRun, WorkflowStartRequest } from '@hiveforge-ai/dsh-workflow'
