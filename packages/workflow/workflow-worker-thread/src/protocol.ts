 ...
 * @module @hiveforge-ai/dsh-workflow-worker-thread/protocol
 */

import type { WorkflowAgentEndInfo, WorkflowAgentInfo, WorkflowResult } from '@hiveforge-ai/dsh-workflow'
