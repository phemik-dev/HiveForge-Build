/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-workflow-worker-thread`.
 * @module @hiveforge-ai/dsh-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-workflow-worker-thread'
