 ...
 * (`@hiveforge-ai/dsh-workflow`), so a hardened engine swaps in without touching what the model
 ...
 * @module @hiveforge-ai/dsh-tool-workflow
 */
...
import type { ToolCallView, ToolResultView } from '@hiveforge-ai/dsh-tools'
import type { ContentBlock } from '@hiveforge-ai/dsh-llm'
import type { JsonValue, Session, SessionEventMap } from '@hiveforge-ai/dsh-session'
import type {
