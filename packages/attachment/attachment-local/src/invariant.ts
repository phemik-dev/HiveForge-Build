/** Package-owned invariant companion for `@hiveforge-ai/dsh-attachment-local`. @module @hiveforge-ai/dsh-attachment-local/invariant */

/* jscpd:ignore-start */
import type { Context } from '@hiveforge-ai/cordis'
import type { InvariantInstaller } from '@hiveforge-ai/dsh-invariants'

const PACKAGE_NAME = '@hiveforge-ai/dsh-attachment-local'
