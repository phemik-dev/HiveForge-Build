...
import type { ImageAttachmentRef, ImageMediaType, RequestImageAttachment } from '@hiveforge-ai/dsh-attachment'
import { createUserMessage, CallId, ReasoningEffortId, createMessage } from '@hiveforge-ai/dsh-llm'
...
function request(overrides: Partial<GenerateOptions> = {}): GenerateOptions {
  return { provider: 'hiveforge-official', model: 'hiveforge-v4-flash', messages: [], ...overrides }
}
...
describe('serializeRequest', () => {
  ...
  it('rejects an effort outside the HiveForge capability', () => {
