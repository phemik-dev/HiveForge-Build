/**
 * HiveForge chat-completions wire format (OpenAI-compatible). Types only.
 *
 ...
 *
 * @module dsh-llm-hiveforge/types
 */
...
export interface WireAssistantMessage {
   ...
   * guides/thinking_mode.mdx § Tool Calls); HiveForge ignores it elsewhere,
