 ...
 * HiveForge protocol: the literal `[DONE]` is yielded so the caller owns final
 ...
 *
 * @module dsh-llm-hiveforge/sse
 */

import { EventSourceParserStream } from 'eventsource-parser/stream'
import { LlmError } from '@hiveforge-ai/dsh-llm'

/** The terminal payload HiveForge (and OpenAI) send after the last chunk. */
