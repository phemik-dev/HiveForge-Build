/**
 * Translate HiveForge SSE payloads with one stateful harness block per content, reasoning, or tool
 ...
 *
 * Translate HiveForge wire chunks into the harness `StreamChunk` protocol.
 * @module dsh-llm-hiveforge/translate
 */

import { CallId, EMPTY_RESPONSE_CODE, LlmError } from '@hiveforge-ai/dsh-llm'
import type { ContentBlock, FinishReason, StreamChunk, TokenUsage } from '@hiveforge-ai/dsh-llm'
...
/**
 * Map wire usage fields. HiveForge's `prompt_tokens` INCLUDES cache hits
