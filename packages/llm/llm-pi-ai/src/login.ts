...
import type { AuthorizationMethod, AuthorizationPrompt, AuthorizationSession } from '@hiveforge-ai/dsh-authorization'
import { isCredentialKeySegment } from '@hiveforge-ai/dsh-credentials'
