/** Package-owned durable retry-event invariants. @module @hiveforge-ai/dsh-llm-retry/invariant */

import type { Context } from '@hiveforge-ai/cordis'
import type { Session, SessionEvent } from '@hiveforge-ai/dsh-session'
import type { LlmFailure } from '@hiveforge-ai/dsh-llm'
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-llm-retry'
