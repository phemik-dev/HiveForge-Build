/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-token-meter`.
 * @module @hiveforge-ai/dsh-token-meter/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-token-meter'
