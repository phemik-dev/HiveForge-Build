/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-skill`.
 * @module @hiveforge-ai/dsh-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-skill'
