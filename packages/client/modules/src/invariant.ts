/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-modules`.
 * @module @hiveforge-ai/dsh-client-modules/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-modules'
