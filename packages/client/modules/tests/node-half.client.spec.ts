...
import { renderIndexInjections, type WebServer, type WebRoute } from '@hiveforge-ai/dsh-host-webserver'
...
const MODULES_ID = '@hiveforge-ai/dsh-client-modules'
const RUNTIME_ID = '@hiveforge-ai/dsh-client-runtime'
...
describe('module graph order', () => {
  ...
  it('leaves a request no row answers to the static assembly channel', () => {
    expect(ids(orderByModuleGraph([
      entry('consumer', { external: ['@hiveforge-ai/cordis'] }),
      entry('other'),
