/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-model-selection`.
 * @module @hiveforge-ai/dsh-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-model-selection'
