/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-brand-official`.
 * @module @hiveforge-ai/dsh-client-ui-brand-official/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-brand-official'
