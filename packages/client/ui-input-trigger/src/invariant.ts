/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-input-trigger`.
 * @module @hiveforge-ai/dsh-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-input-trigger'
