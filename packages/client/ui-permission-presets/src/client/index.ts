 ...
 */
import type { ConnectionHandle } from '@hiveforge-ai/dsh-api-remotes/client'
...
import type {} from '@hiveforge-ai/dsh-client-ui-settings/client'
// Type-only: pulls the ctx.remote merge and the forwarded-event key face
// (the settings invalidation rides the allowlist) into this program.
import type {} from '@hiveforge-ai/dsh-api-remotes/client'
import type { ClientContext, SessionFace } from '@hiveforge-ai/dsh-client-runtime/client'
import type { CommandUiContract, SelectOption } from '@hiveforge-ai/dsh-client-ui-commands/client'
import type { ClientSessionContext } from '@hiveforge-ai/dsh-client-ui-input-trigger/client'
import type { PermissionSelect } from '@hiveforge-ai/dsh-permission-presets/client'
