...
import type { StateDotState } from '@hiveforge-ai/dsh-client-ui-primitives'
import { abbreviateHomePath } from '@hiveforge-ai/dsh-client-runtime/client'
...
/** Localized compact relative time (the equivalents of "now"/"5min" in each locale). */
