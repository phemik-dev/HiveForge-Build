/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-workspace`.
 * @module @hiveforge-ai/dsh-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-workspace'
