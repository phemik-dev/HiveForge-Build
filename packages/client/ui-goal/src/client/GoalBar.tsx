...
import type { GoalSnapshot } from '@hiveforge-ai/dsh-goal/client'
import {
...
import type { PropsLocale } from '@hiveforge-ai/dsh-client-ui-slots'
...
export type GoalDockProps = import('@hiveforge-ai/dsh-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
