/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-goal`.
 * @module @hiveforge-ai/dsh-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-goal'
