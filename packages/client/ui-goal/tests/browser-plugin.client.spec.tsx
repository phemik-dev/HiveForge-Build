...
import { ConversationEventRegistry } from '@hiveforge-ai/dsh-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@hiveforge-ai/dsh-goal/client'
