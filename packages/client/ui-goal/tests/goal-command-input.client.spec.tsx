...
import { ConversationNodeAssembler } from '@hiveforge-ai/dsh-client-runtime/client'
...
import type { SessionEvent } from '@hiveforge-ai/dsh-session/types'
import { commandDefinition } from '@hiveforge-ai/dsh-client-ui-conversation/src/client/conversation-nodes/command.ts'
import { chatViewDefinition } from '@hiveforge-ai/dsh-client-ui-conversation/src/client/conversation-nodes/chat-snapshot-builder.ts'
