/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-conversation`.
 * @module @hiveforge-ai/dsh-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-conversation'
