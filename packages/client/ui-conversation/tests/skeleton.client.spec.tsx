...
import { en as commonEn } from '@hiveforge-ai/dsh-client-locale/src/locales/en.ts'
...
describe('Hero chrome', () => {
  it('renders the English preview badge through the hero locale seat', () => {
    ...
    expect(view.getByText('What shall we forge?')).toBeTruthy()
    expect(view.getByText('HiveForge Preview')).toBeTruthy()
...
describe('ConversationRoot resident composer', () => {
  ...
  it('hero phase: same textarea, hero chrome, no header, picker switches the workspace', () => {
    ...
    expect(b.view.getByText('What shall we forge?')).toBeTruthy()
    expect(b.view.getByText('HiveForge Preview')).toBeTruthy()
  ...
  it('settling phase: a summary that does not prove the session blank hides the composer while it opens', () => {
    ...
    expect(b.view.queryByText('What shall we forge?')).toBeNull()
  })
