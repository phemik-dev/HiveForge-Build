...
import type { ISession, SessionId } from '@hiveforge-ai/dsh-client-runtime/client'
...
import { apply, inject, type EmptyWorkspaceOwnerProps } from '@hiveforge-ai/dsh-client-ui-conversation/client'
