/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-commands`.
 * @module @hiveforge-ai/dsh-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-commands'
