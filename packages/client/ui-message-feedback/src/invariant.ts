/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-message-feedback`.
 * @module @hiveforge-ai/dsh-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-message-feedback'
