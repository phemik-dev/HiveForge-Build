 ...
 * @module @hiveforge-ai/dsh-client-ui-message-feedback/client/controller
 */

import type { RemoteResult } from '@hiveforge-ai/dsh-typert-protocol'
import type { HostObservable } from '@hiveforge-ai/dsh-client-ui-slots'
import type { MessageId, SessionId } from '@hiveforge-ai/dsh-client-connection/client'
import type {
...
} from '@hiveforge-ai/dsh-message-feedback/types'
