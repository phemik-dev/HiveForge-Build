...
describe('highlightToHtml', () => {
  ...
  it('lazily loads every read-card grammar: plain first, highlighted after load', { timeout: process.platform === 'win32' ? 45_000 : 30_000 }, async () => {
    ...
    }, { timeout: process.platform === 'win32' ? 30_000 : 20_000 })
  })
})
...
describe('CodeBlock', () => {
  ...
  it('shows the language banner and copies the pre textContent', { timeout: 20_000 }, async () => {
    vi.useFakeTimers()
