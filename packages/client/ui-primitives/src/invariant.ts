/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-primitives`.
 * @module @hiveforge-ai/dsh-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-primitives'
