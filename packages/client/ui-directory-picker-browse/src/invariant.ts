/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-directory-picker-browse`.
 * @module @hiveforge-ai/dsh-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-directory-picker-browse'
