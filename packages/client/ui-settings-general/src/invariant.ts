/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-settings-general`.
 * @module @hiveforge-ai/dsh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-settings-general'
