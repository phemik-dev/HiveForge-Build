 ...
 * ({@link module:@hiveforge-ai/dsh-tools/src/presentation}). This derivation
 ...
 * @module
 */
import type { SearchBlockProps, SearchFileGroup } from '@hiveforge-ai/dsh-client-ui-primitives'
