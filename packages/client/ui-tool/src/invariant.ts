/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-tool`.
 * @module @hiveforge-ai/dsh-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-tool'
