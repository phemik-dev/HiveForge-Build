...
import type { SessionProviderComponent, TranslateNS } from '@hiveforge-ai/dsh-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@hiveforge-ai/dsh-client-ui-conversation/src/client/contract/slots.ts'
