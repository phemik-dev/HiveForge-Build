...
import type { ConvViewProps, ViewTab } from '@hiveforge-ai/dsh-client-ui-conversation/client'
import {
...
describe('tab switching in ConversationRoot', () => {
  it('renders two tabs, defaults to chat, and switches to the trajectory ledger', { timeout: 20_000 }, async () => {
    const b = await bench()
