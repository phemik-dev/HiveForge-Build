/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-trajectory`.
 * @module @hiveforge-ai/dsh-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-trajectory'
