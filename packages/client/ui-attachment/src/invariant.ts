/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-attachment`.
 * @module @hiveforge-ai/dsh-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-attachment'
