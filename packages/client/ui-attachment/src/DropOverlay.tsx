 ...
 * (HiveForge Chat's DragMask). Decoration only: `pointer-events: none` keeps
...
/** Tilted photo-and-note cards (HiveForge Chat upload illustration). */
...
/** Greyed cards with a blocked badge (HiveForge Chat disabled illustration). */
