/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-settings-plugins`.
 * @module @hiveforge-ai/dsh-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-settings-plugins'
