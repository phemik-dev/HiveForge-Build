/**
 * The web-search card's staged form over the `web-search-hiveforge` settings
 * namespace.
 *
...
import type { IApiClient } from '@hiveforge-ai/dsh-client-connection/client'
import type { SettingsScope, SettingsScopeSnapshot, SnapshotStore } from '@hiveforge-ai/dsh-client-runtime/client'
import {
...
/**
 * Namespace of the HiveForge search provider. Spelled here rather than
 * imported: a client package must not depend on a Host package.
 */
export const WEB_SEARCH_NS = 'web-search-hiveforge'

/** Credential reference the provider resolves when the section names none. */
const DEFAULT_API_KEY_REF = 'HIVEFORGE_API_KEY'
...
/** Bridges the `web-search-hiveforge` scope and the credentials domain onto the card. */
export class WebSearchCardController {
  ...
  /**
   * @param scope - the bound settings scope for the `web-search-hiveforge` namespace.
