...
import type { StoredEntry } from '@hiveforge-ai/dsh-client-ui-slots'
import { createSnapshotStore, type SnapshotStore } from '@hiveforge-ai/dsh-client-runtime/client'
