/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-plan`.
 * @module @hiveforge-ai/dsh-client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-plan'
