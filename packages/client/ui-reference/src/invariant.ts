/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-reference`.
 * @module @hiveforge-ai/dsh-client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-reference'
