/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-user-questions`.
 * @module @hiveforge-ai/dsh-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-user-questions'
