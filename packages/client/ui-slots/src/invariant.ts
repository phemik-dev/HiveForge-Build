/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-slots`.
 * @module @hiveforge-ai/dsh-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-slots'
