/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-runtime`.
 * @module @hiveforge-ai/dsh-client-runtime/invariant
 */
...
import type { SlotMap } from '@hiveforge-ai/dsh-client-ui-slots'
import type { InvariantInstaller } from '@hiveforge-ai/dsh-invariants'

const PACKAGE_NAME = '@hiveforge-ai/dsh-client-runtime'
