/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-agent-preset`.
 * @module @hiveforge-ai/dsh-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-agent-preset'
