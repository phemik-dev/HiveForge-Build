/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-jobs`.
 * @module @hiveforge-ai/dsh-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-jobs'
