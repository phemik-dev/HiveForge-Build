/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-layout`.
 * @module @hiveforge-ai/dsh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-layout'
