/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-web`.
 * @module @hiveforge-ai/dsh-client-web/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-web'
