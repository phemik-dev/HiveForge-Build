 ...
 * @module @hiveforge-ai/dsh-client-web/src/boot
 */
...
} from '@hiveforge-ai/dsh-client-modules/client'
import type {} from '@hiveforge-ai/dsh-client-ui-renderer/client'
...
export class AppWebEntry {
  ...
  async run(): Promise<void> {
    try {
      ...
      // is `ClientTransportHooks`, owned by @hiveforge-ai/dsh-client-connection;
