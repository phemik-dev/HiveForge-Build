...
import * as Cordis from '@hiveforge-ai/cordis'
import * as UiSlots from '@hiveforge-ai/dsh-client-ui-slots'
import * as UiPrimitives from '@hiveforge-ai/dsh-client-ui-primitives'
...
export function getStaticModules(): Record<string, unknown> {
  ...
  return {
    ...
    '@hiveforge-ai/cordis': Cordis,
    '@hiveforge-ai/dsh-client-ui-slots': UiSlots,
    '@hiveforge-ai/dsh-client-ui-primitives': UiPrimitives,
