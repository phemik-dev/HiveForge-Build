...
import type { SessionMaybeProvideInfo, StoredEntry } from '@hiveforge-ai/dsh-client-ui-slots'
import type { SessionProvideInfo, SlotRendererHost } from '@hiveforge-ai/dsh-client-ui-renderer/client'
