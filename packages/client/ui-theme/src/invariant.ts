/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-theme`.
 * @module @hiveforge-ai/dsh-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-theme'
