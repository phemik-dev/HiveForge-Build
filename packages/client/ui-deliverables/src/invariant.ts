/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-deliverables`.
 * @module @hiveforge-ai/dsh-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-deliverables'
