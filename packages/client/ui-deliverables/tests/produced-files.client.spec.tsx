...
import type { ChatFileMentions, TurnTailOwnerProps } from '@hiveforge-ai/dsh-client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@hiveforge-ai/dsh-client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@hiveforge-ai/dsh-client-ui-deliverables'])
