...
import { apply as nodeApply } from '@hiveforge-ai/dsh-client-locale'
import { apply as clientApply, COMMON_NS, LocaleRuntime, inject } from '@hiveforge-ai/dsh-client-locale/client'
import * as LocaleInvariant from '@hiveforge-ai/dsh-client-locale/invariant'
