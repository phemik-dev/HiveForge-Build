...
import type { ClientContext, SettingsScope } from '@hiveforge-ai/dsh-client-runtime/client'
...
export type { Translate, TranslateNS } from '@hiveforge-ai/dsh-client-ui-slots'
