/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-locale`.
 * @module @hiveforge-ai/dsh-client-locale/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-locale'
