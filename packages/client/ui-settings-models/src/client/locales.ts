...
export const en = {
  ...
  legacyImportTitle: 'Import previous settings',
  legacyImportDescription: 'HiveForge found a previous configuration folder at {path}. Import it into this installation?',
  legacyImportPreviewFailed: 'Legacy import is unavailable right now. You can skip this step and configure providers manually in Models.',
  legacyImportSettingsFound: 'settings.yaml: found ({count} section(s))',
  legacyImportSettingsFoundWithError: 'settings.yaml: found (could not parse)',
  legacyImportSettingsMissing: 'settings.yaml: not found',
  legacyImportCredentialsFound: '.credentials.yaml: found ({refs} key(s), {records} record(s))',
  legacyImportCredentialsFoundWithError: '.credentials.yaml: found (could not parse)',
  legacyImportCredentialsMissing: '.credentials.yaml: not found',
  legacyImportImport: 'Import',
  legacyImportImporting: 'Importing…',
  legacyImportSkip: 'Skip',
  legacyImportCannotImport: 'One of the legacy documents could not be parsed. Fix it and restart, or skip and configure manually.',
}
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  onboardingDescription: '配置一个模型提供方即可开始使用。',
  onboardingLater: '稍后配置',
  onboardingSave: '保存并继续',
  onboardingSaving: '保存中…',
  keyRequired: '请输入 API 密钥后继续。',
  legacyImportTitle: '导入旧配置',
  legacyImportDescription: 'HiveForge 在 {path} 发现了旧的配置文件夹。是否导入到当前安装？',
  legacyImportPreviewFailed: '暂时无法读取旧配置。你可以跳过此步骤，稍后在「模型」中手动配置提供方。',
  legacyImportSettingsFound: 'settings.yaml：已找到（{count} 个分区）',
  legacyImportSettingsFoundWithError: 'settings.yaml：已找到（无法解析）',
  legacyImportSettingsMissing: 'settings.yaml：未找到',
  legacyImportCredentialsFound: '.credentials.yaml：已找到（{refs} 个密钥，{records} 条记录）',
  legacyImportCredentialsFoundWithError: '.credentials.yaml：已找到（无法解析）',
  legacyImportCredentialsMissing: '.credentials.yaml：未找到',
  legacyImportImport: '导入',
  legacyImportImporting: '导入中…',
  legacyImportSkip: '跳过',
  legacyImportCannotImport: '旧配置文件无法解析。请修复后重启，或跳过并手动配置。',
}
