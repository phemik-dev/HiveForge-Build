 ...
 * @module @hiveforge-ai/dsh-client-ui-settings-models/apiKey
 */

/**
 * Twin of `normalizeApiKey` in `@hiveforge-ai/dsh-llm`: printable ASCII, space
 ...
 * the model-catalog validator is kept in step with the host's `catalogModel`.
 */
