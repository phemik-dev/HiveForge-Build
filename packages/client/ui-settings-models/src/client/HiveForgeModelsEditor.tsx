 ...
 * (rejected by {@link validateHiveForgeModels} before any write).
 */
...
export interface HiveForgeModelsValidationFailure {
...
export function modelDrafts(value: unknown): HiveForgeModelDraft[] {
  if (!Array.isArray(value)) return []
  return value.map(entry =>
    typeof entry === 'object' && entry !== null && !Array.isArray(entry)
      ? entry as HiveForgeModelDraft
      : {})
}
 ...
 */
export function validateHiveForgeModels(value: unknown): HiveForgeModelsValidationFailure | undefined {
...
/** Props of {@link HiveForgeModelsEditor}. */
export interface HiveForgeModelsEditorProps {
  /** Effective rows: inherited until the parent materializes an override. */
  models: readonly HiveForgeModelDraft[]
  ...
  onChange: (models: HiveForgeModelDraft[]) => void
 ...
 */
export function HiveForgeModelsEditor(props: HiveForgeModelsEditorProps): ReactNode {
  ...
  const capacityText = (model: HiveForgeModelDraft, index: number, field: CapacityField): string => {
