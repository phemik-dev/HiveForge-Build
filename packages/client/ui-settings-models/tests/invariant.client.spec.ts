...
import * as ModelsInvariant from '@hiveforge-ai/dsh-client-ui-settings-models/invariant'
...
describe('invariant companion', () => {
  ...
  it('node-half apply is a no-op host placeholder', async () => {
    const { apply } = await import('@hiveforge-ai/dsh-client-ui-settings-models')
    apply()
