/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-settings`.
 * @module @hiveforge-ai/dsh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-settings'
