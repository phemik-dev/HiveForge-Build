/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-connection`.
 * @module @hiveforge-ai/dsh-client-connection/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-connection'
