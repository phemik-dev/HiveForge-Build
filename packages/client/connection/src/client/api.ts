...
export type {
  ...
  JobView,
} from '@hiveforge-ai/dsh-host-apiproxy/api'
...
export { AbstractApiClient } from '@hiveforge-ai/dsh-host-apiproxy/client'
export type { IApiClient } from '@hiveforge-ai/dsh-host-apiproxy/client'
export type { SessionId, SessionEvent } from '@hiveforge-ai/dsh-session/types'
export type { MessageId } from '@hiveforge-ai/dsh-llm/brand'
export type { ContentBlock, StreamChunk } from '@hiveforge-ai/dsh-llm/types'

/** Successful value returned by the connection-generation host handshake. */
export type HostDescription = import('@hiveforge-ai/dsh-host-apiproxy/api').ResponseValue<'host.describe'>

import type { RpcResponse, RpcResult } from '@hiveforge-ai/dsh-host-apiproxy/api'
