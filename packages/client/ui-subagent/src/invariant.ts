/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-subagent`.
 * @module @hiveforge-ai/dsh-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-subagent'
