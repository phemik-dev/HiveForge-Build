/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-hmr`.
 * @module @hiveforge-ai/dsh-client-hmr/invariant
 */

import type { Context, Fiber } from '@hiveforge-ai/cordis'
import type { InvariantInstaller } from '@hiveforge-ai/dsh-invariants'

const PACKAGE_NAME = '@hiveforge-ai/dsh-client-hmr'
