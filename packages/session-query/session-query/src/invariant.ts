/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-session-query`.
 * @module @hiveforge-ai/dsh-session-query/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-session-query'
