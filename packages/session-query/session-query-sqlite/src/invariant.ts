/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-session-query-sqlite`.
 * @module @hiveforge-ai/dsh-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-session-query-sqlite'
