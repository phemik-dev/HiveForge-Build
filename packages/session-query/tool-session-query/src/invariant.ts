/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-tool-session-query`.
 * @module @hiveforge-ai/dsh-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-tool-session-query'
