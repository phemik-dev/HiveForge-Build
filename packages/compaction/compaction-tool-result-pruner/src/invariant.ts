/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-compaction-tool-result-pruner`.
 * @module @hiveforge-ai/dsh-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-compaction-tool-result-pruner'
