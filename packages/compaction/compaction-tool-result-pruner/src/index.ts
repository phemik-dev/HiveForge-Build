 ...
 *
 * @module @hiveforge-ai/dsh-compaction-tool-result-pruner
 */

import { Context, Service } from '@hiveforge-ai/cordis'
import z from '@hiveforge-ai/schemastery'
import { freezeMessage } from '@hiveforge-ai/dsh-llm'
import type { ContentBlock } from '@hiveforge-ai/dsh-llm'
import type { Session, SessionEvent, ToolResultMessage } from '@hiveforge-ai/dsh-session'
