 ...
 *
 * @module @hiveforge-ai/dsh-compaction-basic
 */

import { Context } from '@hiveforge-ai/cordis'
import z from '@hiveforge-ai/schemastery'
import { CompactionEngine, ManualCompactionError } from '@hiveforge-ai/dsh-compaction'
import type { CompactionResult, CompactionTrigger } from '@hiveforge-ai/dsh-compaction'
import type { TokenMeter } from '@hiveforge-ai/dsh-token-meter'
import type { Session } from '@hiveforge-ai/dsh-session'
import { CONTEXT_WINDOW_EXCEEDED_CODE, assertNever } from '@hiveforge-ai/dsh-llm'
import type { LlmCallConfig } from '@hiveforge-ai/dsh-llm'
...
import type {} from '@hiveforge-ai/dsh-compaction-tool-result-pruner'
import {
  resolveCompactSpec,
  resolveConfig,
  resolveTargetPolicy,
