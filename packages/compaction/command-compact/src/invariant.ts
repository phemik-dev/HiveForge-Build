/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-command-compact`.
 * @module @hiveforge-ai/dsh-command-compact/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-command-compact'
