 ...
 *
 * The seam itself lives in `@hiveforge-ai/dsh-compaction`, which re-exports these
 ...
 *
 * @module @hiveforge-ai/dsh-compaction/checkpoint
 */

import type { MessageSource } from '@hiveforge-ai/dsh-llm/message'
