/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-tool-subagent-report`.
 * @module @hiveforge-ai/dsh-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-tool-subagent-report'
