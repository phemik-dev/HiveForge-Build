/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-tool-subagent-control`.
 * @module @hiveforge-ai/dsh-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-tool-subagent-control'
