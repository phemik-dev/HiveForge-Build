 ...
 * (`@hiveforge-ai/dsh-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@hiveforge-ai/dsh-tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@hiveforge-ai/dsh-tools'
import type { ContentBlock, MessageId } from '@hiveforge-ai/dsh-llm'
