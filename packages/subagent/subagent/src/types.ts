 ...
 *
 * @module @hiveforge-ai/dsh-subagent/types
 */

import type { Agent, AgentOptions } from '@hiveforge-ai/dsh-agent'
...
import type { ObjectJsonSchema, ToolRestriction } from '@hiveforge-ai/dsh-tools'
