 ...
 *
 * @module @hiveforge-ai/dsh-subagent
 */

import type { Context } from '@hiveforge-ai/cordis'
import type { Session, SessionEvent, SessionHeader, SessionId } from '@hiveforge-ai/dsh-session'
import type { SessionPersistence } from '@hiveforge-ai/dsh-session-persistence'
import type { SessionProjectionRegistry } from '@hiveforge-ai/dsh-session-projection'
import type { SessionProjectionCache } from '@hiveforge-ai/dsh-session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @hiveforge-ai/dsh-session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @hiveforge-ai/dsh-session)',
