 ...
 * @module @hiveforge-ai/dsh-subagent-acp/run
 */
...
import { AssistantOutputFold } from '@hiveforge-ai/dsh-subagent'
...
export interface AcpRunSpec {
   ...
   * `HIVEFORGE_API_KEY`). Merged on top of the subprocess seam's scrubbed
