/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-subagent-dsh-sdk`.
 * @module @hiveforge-ai/dsh-subagent-dsh-sdk/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-subagent-dsh-sdk'
