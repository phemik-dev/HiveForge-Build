/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-subagent-codex`.
 * @module @hiveforge-ai/dsh-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-subagent-codex'
