 ...
 *
 * @module @hiveforge-ai/dsh-subagent-codex/wire
 */

import type { Readable, Writable } from 'node:stream'
import type { ContentBlock } from '@hiveforge-ai/dsh-llm'
import type { SubagentResult } from '@hiveforge-ai/dsh-subagent'
import { JsonRpcLineTransport } from '@hiveforge-ai/dsh-sdk-protocol'
