/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-tool-subagent`.
 * @module @hiveforge-ai/dsh-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-tool-subagent'
