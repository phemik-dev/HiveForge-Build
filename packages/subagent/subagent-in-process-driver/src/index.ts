 ...
 * one result.
 *
 * @module @hiveforge-ai/dsh-subagent-in-process-driver
 */

import { randomUUID } from 'node:crypto'
import type { Context } from '@hiveforge-ai/cordis'
import { foldConsumedWork } from '@hiveforge-ai/dsh-agent'
...
import { createUserMessage, type ContentBlock } from '@hiveforge-ai/dsh-llm'
import {
