/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-lsp-stdio`.
 * @module @hiveforge-ai/dsh-lsp-stdio/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-lsp-stdio'
