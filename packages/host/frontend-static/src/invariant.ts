/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-host-frontend-static`.
 * @module @hiveforge-ai/dsh-host-frontend-static/invariant
 */

import type { Context } from '@hiveforge-ai/cordis'
import type { InvariantInstaller } from '@hiveforge-ai/dsh-invariants'

const PACKAGE_NAME = '@hiveforge-ai/dsh-host-frontend-static'
