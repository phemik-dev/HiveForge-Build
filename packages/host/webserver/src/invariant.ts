/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-host-webserver`.
 * @module @hiveforge-ai/dsh-host-webserver/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-host-webserver'
