...
import HttpServer from '@hiveforge-ai/dsh-host-webserver'
import type { DirectoryPicker } from '@hiveforge-ai/dsh-host-directory-picker'
import BrowseDirectoryPicker from '@hiveforge-ai/dsh-host-directory-picker-browse'
import NativeDirectoryPicker from '@hiveforge-ai/dsh-host-directory-picker-native'
...
const AUTO = '@hiveforge-ai/dsh-host-directory-picker-auto'
const NATIVE = '@hiveforge-ai/dsh-host-directory-picker-native'
const BROWSE = '@hiveforge-ai/dsh-host-directory-picker-browse'
const NATIVE_SURFACE = '@hiveforge-ai/dsh-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@hiveforge-ai/dsh-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  const modules = new Map<string, unknown>([
    ['@hiveforge-ai/dsh-host-webserver', HttpServer],
