 ...
 * @module @hiveforge-ai/dsh-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@hiveforge-ai/dsh-host-directory-picker-native',
  browse: '@hiveforge-ai/dsh-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@hiveforge-ai/dsh-client-ui-directory-picker-native',
  browse: '@hiveforge-ai/dsh-client-ui-directory-picker-browse',
}
