/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-host-apiproxy`.
 * @module @hiveforge-ai/dsh-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-host-apiproxy'
