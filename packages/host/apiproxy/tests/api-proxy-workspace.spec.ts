...
import type { Agent, AgentFactory } from '@hiveforge-ai/dsh-agent'
...
import type { DirectoryPickerCapability } from '@hiveforge-ai/dsh-host-directory-picker'
import WorkspaceRegistry from '@hiveforge-ai/dsh-workspace'
import type { HostFrame, WorkspaceId } from '@hiveforge-ai/dsh-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@hiveforge-ai/dsh-host-apiproxy/api/rpc'
