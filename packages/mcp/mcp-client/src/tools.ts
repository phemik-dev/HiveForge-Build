 ...
 * is `mcp__<serverName>__<rawName>`, normalized to the HiveForge function-name
...
import { isImageAdmissionError } from '@hiveforge-ai/dsh-attachment'
import type { AttachmentStore, ImageAttachmentRef, ImageMediaType, SaveImageAttachment } from '@hiveforge-ai/dsh-attachment'
import type { ContentBlock } from '@hiveforge-ai/dsh-llm'
import type { ToolDefinition, ToolExecution, ToolExecutionResult } from '@hiveforge-ai/dsh-tools'
import { assertSupportedJsonSchema } from '@hiveforge-ai/dsh-tools'
import type { JsonSchemaNode, JsonValue } from '@hiveforge-ai/dsh-tools'
...
/**
 * HiveForge function-name contract: at most 64 characters. Wire-protocol
 * constant, not configuration.
 */
const MAX_PUBLIC_NAME_LENGTH = 64

/** HiveForge function-name contract: only `[A-Za-z0-9_-]` is allowed. */
 ...
 * truncation to the HiveForge function-name contract (64 chars,
