/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-mcp-client`.
 * @module @hiveforge-ai/dsh-mcp-client/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-mcp-client'
