/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-code-runtime-python`.
 * @module @hiveforge-ai/dsh-code-runtime-python/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-code-runtime-python'
