/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-code-runtime-worker-thread`.
 * @module @hiveforge-ai/dsh-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-code-runtime-worker-thread'
