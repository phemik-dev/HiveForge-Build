/** JSON string-prefix accounting for the outer-output ledger. @module @hiveforge-ai/dsh-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@hiveforge-ai/dsh-code-runtime'
