/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-tool-ask-user`.
 * @module @hiveforge-ai/dsh-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-tool-ask-user'
