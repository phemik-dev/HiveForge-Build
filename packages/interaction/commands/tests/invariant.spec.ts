...
import * as CommandInvariant from '@hiveforge-ai/dsh-commands/invariant'
...
import { CommandId } from '@hiveforge-ai/dsh-commands'
...
describe('command lifecycle invariants', () => {
  ...
  it.each([-1, 1.5, 1])('rejects invalid or non-prior sourceEventSeq %s', async (sourceEventSeq) => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@hiveforge-ai/dsh-commands',
    }))
  })
