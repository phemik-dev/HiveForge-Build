/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-user-questions`.
 * @module @hiveforge-ai/dsh-user-questions/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-user-questions'
