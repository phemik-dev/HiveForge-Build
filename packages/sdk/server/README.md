...
- **Automatic adapter mounting is HiveForge-specific** — `initialize` can reuse any pre-registered model adapter, but its only fallback mounts `dsh-llm-hiveforge`.
