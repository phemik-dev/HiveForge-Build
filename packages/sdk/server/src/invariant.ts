/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-sdk-jsonrpc-server`.
 * @module @hiveforge-ai/dsh-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-sdk-jsonrpc-server'
