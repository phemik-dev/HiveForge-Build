/**
 * Shared wire protocol for the HiveForge Harness SDK runtime: the
 ...
 * (`@hiveforge-ai/dsh-sdk-jsonrpc-server`) serves this protocol; SDK clients
 * (`@hiveforge-ai/dsh-sdk-client`, the Python SDK) drive it.
 *
 * @module @hiveforge-ai/dsh-sdk-protocol
 */
