/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-sdk-protocol`.
 * @module @hiveforge-ai/dsh-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-sdk-protocol'
