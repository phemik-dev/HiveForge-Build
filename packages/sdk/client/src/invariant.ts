/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-sdk-client`.
 * @module @hiveforge-ai/dsh-sdk-client/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-sdk-client'
