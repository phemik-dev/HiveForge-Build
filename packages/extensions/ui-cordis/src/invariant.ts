/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-client-ui-cordis`.
 * @module @hiveforge-ai/dsh-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-client-ui-cordis'
