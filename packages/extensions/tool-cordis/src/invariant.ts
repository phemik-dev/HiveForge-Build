/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-tool-cordis`.
 * @module @hiveforge-ai/dsh-tool-cordis/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-tool-cordis'
