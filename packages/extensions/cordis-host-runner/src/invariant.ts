/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-cordis-host-runner`.
 * @module @hiveforge-ai/dsh-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-cordis-host-runner'
