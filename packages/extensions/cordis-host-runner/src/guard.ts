 ...
 * @module @hiveforge-ai/dsh-cordis-host-runner/guard
 */

import { Context } from '@hiveforge-ai/cordis'
import type { Plugin } from '@hiveforge-ai/cordis'
import { scopeOf } from '@hiveforge-ai/dsh-scope'
import { assertSupportedJsonSchema, defineTool } from '@hiveforge-ai/dsh-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@hiveforge-ai/dsh-cordis-client-runner`, whose CTX_VERBS names this one its
