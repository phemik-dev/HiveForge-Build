/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-cordis-client-runner`.
 * @module @hiveforge-ai/dsh-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-cordis-client-runner'
