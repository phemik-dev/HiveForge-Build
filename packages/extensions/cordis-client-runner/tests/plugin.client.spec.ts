...
import InvariantService from '@hiveforge-ai/dsh-invariants'
import type {
...
import type { DynamicCordisInvokeResult } from '@hiveforge-ai/dsh-api-remotes/client'
// Type-only: resolves `ctx.remote` and with it the `$on`/`$dispatch` surface.
import type {} from '@hiveforge-ai/dsh-api-gateway/client'
