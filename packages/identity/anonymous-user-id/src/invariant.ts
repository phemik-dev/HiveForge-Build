/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-anonymous-user-id`.
 * @module @hiveforge-ai/dsh-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-anonymous-user-id'
