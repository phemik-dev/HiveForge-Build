/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-tool-skill`.
 * @module @hiveforge-ai/dsh-tool-skill/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-tool-skill'
