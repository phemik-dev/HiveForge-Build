/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-skill-badge`.
 * @module @hiveforge-ai/dsh-skill-badge/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-skill-badge'
