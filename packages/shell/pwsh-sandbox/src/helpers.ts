 ...
 * mirror of `@hiveforge-ai/dsh-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @hiveforge-ai/dsh-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@hiveforge-ai/dsh-shell'
import type { RunnerFailureRule } from '@hiveforge-ai/dsh-sandbox'
