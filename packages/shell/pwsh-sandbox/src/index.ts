 ...
 * `@hiveforge-ai/dsh-bash-sandbox`. It wraps the exact local pwsh argv through
 ...
 * renders.
 * @module @hiveforge-ai/dsh-pwsh-sandbox
 */
...
import type { Config as LocalConfig } from '@hiveforge-ai/dsh-pwsh-local'
