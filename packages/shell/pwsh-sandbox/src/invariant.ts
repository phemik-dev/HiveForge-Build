/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-pwsh-sandbox`.
 * @module @hiveforge-ai/dsh-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-pwsh-sandbox'
