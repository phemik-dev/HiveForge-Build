/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-tool-bash`.
 * @module @hiveforge-ai/dsh-tool-bash/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-tool-bash'
