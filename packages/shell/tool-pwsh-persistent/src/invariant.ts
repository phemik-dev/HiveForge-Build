/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-tool-pwsh-persistent`.
 * @module @hiveforge-ai/dsh-tool-pwsh-persistent/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-tool-pwsh-persistent'
