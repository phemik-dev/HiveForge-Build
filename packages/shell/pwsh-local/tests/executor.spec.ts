/**
 * Real-process tests for `@hiveforge-ai/dsh-pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@hiveforge-ai/dsh-pwsh-local'
...
import type { SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@hiveforge-ai/dsh-subprocess'
import { MAX_TIMER_DELAY_MS } from '@hiveforge-ai/dsh-timeout'
import type { ShellProcess } from '@hiveforge-ai/dsh-shell'
