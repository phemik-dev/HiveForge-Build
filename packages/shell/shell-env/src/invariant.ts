/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-shell-env`.
 * @module @hiveforge-ai/dsh-shell-env/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-shell-env'
