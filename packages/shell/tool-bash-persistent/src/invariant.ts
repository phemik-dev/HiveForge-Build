/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-tool-bash-persistent`.
 * @module @hiveforge-ai/dsh-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-tool-bash-persistent'
