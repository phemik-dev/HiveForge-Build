/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-atomic-write`.
 * @module @hiveforge-ai/dsh-atomic-write/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-atomic-write'
