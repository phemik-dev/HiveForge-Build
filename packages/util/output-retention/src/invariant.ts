/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-output-retention`.
 * @module @hiveforge-ai/dsh-output-retention/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-output-retention'
