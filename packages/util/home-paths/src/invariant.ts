/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-home-paths`.
 * @module @hiveforge-ai/dsh-home-paths/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-home-paths'
