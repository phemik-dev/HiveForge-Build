/**
 * Shared filesystem path helpers for HiveForge Harness user data.
 *
 * @module @hiveforge-ai/dsh-home-paths
 */
...
/** Directory name for the default HiveForge Harness home under the OS home. */
export const DSH_HOME_DIR_NAME = '.dsh'

/** Stable user-facing display form for the default HiveForge Harness home. */
export const DEFAULT_DSH_HOME_DISPLAY = `~/${DSH_HOME_DIR_NAME}`

/** Environment variable that overrides the default HiveForge Harness home. */
...
/**
 * Resolve the default HiveForge Harness home using Node's platform path rules.
...
/**
 * Resolve the single-root HiveForge Harness home.
 *
...
/**
 * Join path segments onto the resolved HiveForge Harness home.
