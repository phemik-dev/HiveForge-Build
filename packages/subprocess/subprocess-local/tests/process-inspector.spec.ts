...
import {
  ...
  parseProcStat,
} from '@hiveforge-ai/dsh-subprocess-local/src/process-inspector.ts'
import type { ProcessInspectorInternals } from '@hiveforge-ai/dsh-subprocess-local/src/process-inspector.ts'
import { WindowsProcessInspector } from '@hiveforge-ai/dsh-subprocess-local/src/windows-inspector.ts'
