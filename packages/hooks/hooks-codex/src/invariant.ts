/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-hooks-codex`.
 * @module @hiveforge-ai/dsh-hooks-codex/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-hooks-codex'
