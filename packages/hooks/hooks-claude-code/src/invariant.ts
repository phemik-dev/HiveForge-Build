/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-hooks-claude-code`.
 * @module @hiveforge-ai/dsh-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-hooks-claude-code'
