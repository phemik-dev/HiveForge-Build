/** Package-owned hook invocation/result stream invariants. @module @hiveforge-ai/dsh-hook-protocol/invariant */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-hook-protocol'
