/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-tool-jobs`.
 * @module @hiveforge-ai/dsh-tool-jobs/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-tool-jobs'
