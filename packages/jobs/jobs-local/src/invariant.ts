/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-jobs-local`.
 * @module @hiveforge-ai/dsh-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-jobs-local'
...
/**
 * No runtime invariant: `@hiveforge-ai/dsh-jobs/invariant` owns per-snapshot identity, status,
