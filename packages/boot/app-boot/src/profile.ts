 ...
 * @module @hiveforge-ai/dsh-app-boot/profile
 */
...
import type { EntryOptions } from '@hiveforge-ai/cordis-plugin-loader'
import { applyEntryPatches, type PatchOptions } from '@hiveforge-ai/cordis-plugin-include'
...
export const PROFILE_TEMPLATES: Record<string, readonly string[]> = {
  web: ['@hiveforge-ai/dsh-base', '@hiveforge-ai/dsh-web-app'],
  headless: ['@hiveforge-ai/dsh-base', '@hiveforge-ai/dsh-headless'],
}

/** Installation-owned bundle tuples normalized to the shipped template. */
const INSTALLATION_OWNED_PROFILE_TUPLES: Record<string, readonly string[]> = {
  headless: ['@hiveforge-ai/dsh-base', '@hiveforge-ai/dsh-web-app', '@hiveforge-ai/dsh-headless'],
}

/** The bundle list a `dsh plugin` init uses for a name with no shipped template. */
export const DEFAULT_PROFILE_BUNDLES: readonly string[] = ['@hiveforge-ai/dsh-base']
 ...
 * `@hiveforge-ai/dsh-base` (and every other in-box bundle) always comes from
