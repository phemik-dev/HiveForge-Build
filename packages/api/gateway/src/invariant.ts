/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-api-gateway`.
 * @module @hiveforge-ai/dsh-api-gateway/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-api-gateway'
