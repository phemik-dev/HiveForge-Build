/**
 * Package-owned invariant companion for `@hiveforge-ai/dsh-subprocess-e2b`.
 * @module @hiveforge-ai/dsh-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@hiveforge-ai/dsh-subprocess-e2b'
