import { Context, Service, type Plugin } from '@hiveforge-ai/cordis'
import type { Dict } from '@hiveforge-ai/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@hiveforge-ai/cordis-plugin-loader'
import type { Include } from '@hiveforge-ai/cordis-plugin-include'
import { FSWatcher, watch, type ChokidarOptions } from 'chokidar'
import { dirname, relative, resolve } from 'node:path'
import { realpath, stat } from 'node:fs/promises'
import { handleError } from './error.ts'
import type {} from '@hiveforge-ai/cordis-plugin-timer'
...
namespace Hmr {
  ...
  // [hiveforge-harness] vendored modification: removed `.i18n({ 'en-US': enUS, 'zh-CN': zhCN })`
