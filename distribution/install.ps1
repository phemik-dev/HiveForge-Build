...
$base = if ($tag -eq 'latest') { "https://github.com/$repository/releases/latest/download" } else { "https://github.com/$repository/releases/download/$tag" }
...
try {
  ...
  $root = Join-Path $env:LOCALAPPDATA 'HiveForge'
