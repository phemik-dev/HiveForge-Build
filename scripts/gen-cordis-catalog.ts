...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@hiveforge-ai/dsh-typert-generator'
import type { CordisCatalogPolicy } from '@hiveforge-ai/dsh-typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@hiveforge-ai/cordis'`
 ...
 * scan reads EVERY `declare module '@hiveforge-ai/cordis'` Events merge under
