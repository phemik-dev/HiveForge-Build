...
const REPOSITORY_URL = 'https://github.com/hiveforge-ai/hiveforge-harness'
...
function githubTarget(
  ...
  if (image) return `https://raw.githubusercontent.com/hiveforge-ai/hiveforge-harness/${repositoryRef}/${path}${suffix}`
