...
function checkManifest(
  ...
  if (owner.packageName === '@hiveforge-ai/dsh-invariants') return
  if (manifest.peerDependencies?.['@hiveforge-ai/dsh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@hiveforge-ai/dsh-invariants must be a workspace:^ peerDependency',
    )
  }
  if (manifest.devDependencies?.['@hiveforge-ai/dsh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@hiveforge-ai/dsh-invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@hiveforge-ai/dsh-invariants'
