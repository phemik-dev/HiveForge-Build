...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/identity/anonymous-user-id': { kind: 'none', reason: 'The shared identifier reaches HiveForge only as model-hidden HTTP metadata; it registers nothing model-facing.' },
