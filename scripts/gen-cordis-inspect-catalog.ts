...
import type { CordisCatalogModel, ServiceMethodEntry } from '@hiveforge-ai/dsh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@hiveforge-ai/dsh-tool-cordis/api-catalog', '@hiveforge-ai/dsh-cordis-client-runner/client/api-catalog')
