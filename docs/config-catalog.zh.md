...
<a id="hiveforge-aidsh-acp-demo"></a>
...
依赖：[`agentCore`](../packages/examples/agent-spine-demo/src/index.ts) · [`JsonlCompression`](../packages/session/session-persistence-jsonl/src/index.ts) · [`ToolsConfig`](#hiveforge-aidsh-tools)

来源：[`packages/examples/acp-demo/src/index.ts:39`](../packages/examples/acp-demo/src/index.ts)

<a id="hiveforge-aidsh-agent-default-model"></a>

## `@hiveforge-ai/dsh-agent-default-model`
...
<a id="hiveforge-aidsh-agent-instructions"></a>

## `@hiveforge-ai/dsh-agent-instructions`
...
<a id="hiveforge-aidsh-agent-loop"></a>

## `@hiveforge-ai/dsh-agent-loop`
...
<a id="hiveforge-aidsh-agent-presets"></a>

## `@hiveforge-ai/dsh-agent-presets`
...
<a id="hiveforge-aidsh-agent-spine-demo"></a>

## `@hiveforge-ai/dsh-agent-spine-demo`
...
export interface Config {
  ...
  tools?: ToolsConfig
  /** HiveForge Harness home directory shared by shell context and local skill discovery. */
  dshHome?: string
...
依赖：[`AgentLoopConfig`](#hiveforge-aidsh-agent-loop) · [`GoalDomainConfig`](#hiveforge-aidsh-goal) · [`InvariantConfig`](#hiveforge-aidsh-invariants) · [`JobsConfig`](#hiveforge-aidsh-jobs-local) · [`SessionTitleConfig`](#hiveforge-aidsh-session-title) · [`SkillFileSystem`](../packages/skill/skill-filesystem/src/index.ts) · [`SkillRegistryConfig`](#hiveforge-aidsh-skill) · [`SystemPromptConfig`](#hiveforge-aidsh-system-prompt) · [`toolBash`](../packages/shell/tool-bash/src/index.ts) · [`toolGoal`](../packages/goal/tool-goal/src/index.ts) · [`toolJobs`](../packages/jobs/tool-jobs/src/index.ts) · [`ToolsConfig`](#hiveforge-aidsh-tools) · [`toolSkill`](../packages/skill/tool-skill/src/index.ts) · [`workspaceContext`](../packages/context/agent-instructions/src/index.ts)

来源：[`packages/examples/agent-spine-demo/src/index.ts:92`](../packages/examples/agent-spine-demo/src/index.ts)

<a id="hiveforge-aidsh-agent-tool-presentation"></a>

## `@hiveforge-ai/dsh-agent-tool-presentation`
...
<a id="hiveforge-aidsh-attachment-local"></a>

## `@hiveforge-ai/dsh-attachment-local`
...
<a id="hiveforge-aidsh-bash-local"></a>
...
<a id="hiveforge-aidsh-bash-sandbox"></a>

## `@hiveforge-ai/dsh-bash-sandbox`
...
<a id="hiveforge-aidsh-client-hmr"></a>
...
<a id="hiveforge-aidsh-code-runtime-worker-thread"></a>

## `@hiveforge-ai/dsh-code-runtime-worker-thread`
...
<a id="hiveforge-aidsh-compaction-basic"></a>

## `@hiveforge-ai/dsh-compaction-basic`
...
<a id="hiveforge-aidsh-compaction-tool-result-pruner"></a>
...
<a id="hiveforge-aidsh-cordis-host-runner"></a>

## `@hiveforge-ai/dsh-cordis-host-runner`
...
<a id="hiveforge-aidsh-credentials-local"></a>

## `@hiveforge-ai/dsh-credentials-local`
...
<a id="hiveforge-aidsh-e2b"></a>

## `@hiveforge-ai/dsh-e2b`
...
<a id="hiveforge-aidsh-experimental-agent-team"></a>

## `@hiveforge-ai/dsh-experimental-agent-team`
...
<a id="hiveforge-aidsh-experimental-tool-agent-team"></a>

## `@hiveforge-ai/dsh-experimental-tool-agent-team`
...
<a id="hiveforge-aidsh-file-reference-local"></a>

## `@hiveforge-ai/dsh-file-reference-local`
...
<a id="hiveforge-aidsh-fs-local"></a>

## `@hiveforge-ai/dsh-fs-local`
...
<a id="hiveforge-aidsh-fs-sandbox"></a>

## `@hiveforge-ai/dsh-fs-sandbox`
...
<a id="hiveforge-aidsh-headless"></a>
...
<a id="hiveforge-aidsh-hooks-claude-code"></a>

## `@hiveforge-ai/dsh-hooks-claude-code`
...
<a id="hiveforge-aidsh-hooks-codex"></a>
...
<a id="hiveforge-aidsh-host-apiproxy"></a>

## `@hiveforge-ai/dsh-host-apiproxy`
...
<a id="hiveforge-aidsh-host-directory-picker-browse"></a>
...
<a id="hiveforge-aidsh-host-frontend-static"></a>
...
<a id="hiveforge-aidsh-host-webserver"></a>
...
<a id="hiveforge-aidsh-invariants"></a>

## `@hiveforge-ai/dsh-invariants`
...
<a id="hiveforge-aidsh-jobs-local"></a>

## `@hiveforge-ai/dsh-jobs-local`
...
<a id="hiveforge-aidsh-llm-hiveforge"></a>

## `@hiveforge-ai/dsh-llm-hiveforge`
 ...
 * as the `llm-hiveforge` settings-section shape. Every field is optional in
 ...
 */
export interface Config {
  /** Credential reference (environment-variable name) resolved per request; defaults to `HIVEFORGE_API_KEY`. */
  apiKeyEnv?: string
  /** Endpoint base; falls back to $HIVEFORGE_BASE_URL from a trusted environment layer, then the public API. */
  baseURL?: string
...
export interface HiveForgeCatalogModel {
  ...
  /** Per-request output cap for this model; omission falls back to the profile's {@link HiveForgeConnectionOptions.maxTokens}. */
  maxTokens?: number
...
来源：[`packages/llm/llm-hiveforge/src/index.ts:106`](../packages/llm/llm-hiveforge/src/index.ts)

<a id="hiveforge-aidsh-llm-pi-ai"></a>

## `@hiveforge-ai/dsh-llm-pi-ai`
...
<a id="hiveforge-aidsh-llm-replay"></a>
...
<a id="hiveforge-aidsh-llm-retry"></a>

## `@hiveforge-ai/dsh-llm-retry`
...
<a id="hiveforge-aidsh-lsp-stdio"></a>

## `@hiveforge-ai/dsh-lsp-stdio`
...
<a id="hiveforge-aidsh-mcp-client"></a>

## `@hiveforge-ai/dsh-mcp-client`
...
<a id="hiveforge-aidsh-message-feedback"></a>

## `@hiveforge-ai/dsh-message-feedback`
...
<a id="hiveforge-aidsh-permission-presets"></a>

## `@hiveforge-ai/dsh-permission-presets`
...
<a id="hiveforge-aidsh-persona"></a>

## `@hiveforge-ai/dsh-persona`
...
<a id="hiveforge-aidsh-plan-mode"></a>

## `@hiveforge-ai/dsh-plan-mode`
...
<a id="hiveforge-aidsh-pwsh-local"></a>

## `@hiveforge-ai/dsh-pwsh-local`
...
<a id="hiveforge-aidsh-pwsh-sandbox"></a>

## `@hiveforge-ai/dsh-pwsh-sandbox`
...
依赖：[`LocalConfig`](#hiveforge-aidsh-pwsh-local)

来源：[`packages/shell/pwsh-sandbox/src/index.ts:40`](../packages/shell/pwsh-sandbox/src/index.ts)

<a id="hiveforge-aidsh-repeat-tool-reminder"></a>

## `@hiveforge-ai/dsh-repeat-tool-reminder`
...
<a id="hiveforge-aidsh-sandbox-local"></a>

## `@hiveforge-ai/dsh-sandbox-local`
...
<a id="hiveforge-aidsh-sandbox-policy"></a>

## `@hiveforge-ai/dsh-sandbox-policy`
...
<a id="hiveforge-aidsh-sdk-jsonrpc-server"></a>

## `@hiveforge-ai/dsh-sdk-jsonrpc-server`
...
<a id="hiveforge-aidsh-session-persistence-jsonl"></a>

## `@hiveforge-ai/dsh-session-persistence-jsonl`
...
<a id="hiveforge-aidsh-session-persistence-sqlite"></a>

## `@hiveforge-ai/dsh-session-persistence-sqlite`
...
<a id="hiveforge-aidsh-session-projection-cache"></a>

## `@hiveforge-ai/dsh-session-projection-cache`
...
<a id="hiveforge-aidsh-session-query-sqlite"></a>
...
<a id="hiveforge-aidsh-session-reference"></a>
...
<a id="hiveforge-aidsh-session-telemetry-otel"></a>

## `@hiveforge-ai/dsh-session-telemetry-otel`
...
<a id="hiveforge-aidsh-session-title"></a>

## `@hiveforge-ai/dsh-session-title`
...
<a id="hiveforge-aidsh-session-title-all-prompts-llm"></a>

## `@hiveforge-ai/dsh-session-title-all-prompts-llm`
...
<a id="hiveforge-aidsh-session-title-first-prompt-llm"></a>
...
<a id="hiveforge-aidsh-settings-file"></a>

## `@hiveforge-ai/dsh-settings-file`
...
<a id="hiveforge-aidsh-shell-env"></a>
...
<a id="hiveforge-aidsh-skill"></a>

## `@hiveforge-ai/dsh-skill`
...
<a id="hiveforge-aidsh-skill-filesystem"></a>

## `@hiveforge-ai/dsh-skill-filesystem`
...
export interface Config {
  ...
  /** HiveForge Harness config root. Defaults to `$DSH_HOME` or `~/.dsh`. */
  dshHome?: string
...
<a id="hiveforge-aidsh-spill-local"></a>

## `@hiveforge-ai/dsh-spill-local`
...
<a id="hiveforge-aidsh-spill-policy"></a>

## `@hiveforge-ai/dsh-spill-policy`
...
<a id="hiveforge-aidsh-storage-domain"></a>

## `@hiveforge-ai/dsh-storage-domain`
...
<a id="hiveforge-aidsh-storage-json"></a>

## `@hiveforge-ai/dsh-storage-json`
...
<a id="hiveforge-aidsh-storage-sqlite"></a>

## `@hiveforge-ai/dsh-storage-sqlite`
...
<a id="hiveforge-aidsh-subagent-acp"></a>
...
export interface Config {
   ...
   * harness's own `HIVEFORGE_API_KEY`. Forwarded on top of a credential-scrubbed
...
<a id="hiveforge-aidsh-subagent-claude-code"></a>
...
<a id="hiveforge-aidsh-subagent-codex"></a>
...
<a id="hiveforge-aidsh-subagent-dsh-sdk"></a>
...
<a id="hiveforge-aidsh-subagent-fork-in-process"></a>
...
<a id="hiveforge-aidsh-subagent-spawn-in-process"></a>

## `@hiveforge-ai/dsh-subagent-spawn-in-process`
...
<a id="hiveforge-aidsh-subprocess-e2b"></a>

## `@hiveforge-ai/dsh-subprocess-e2b`
...
<a id="hiveforge-aidsh-system-prompt"></a>

## `@hiveforge-ai/dsh-system-prompt`

```ts config-catalog
/** Plugin config: the deployment-authored fragment of the system prompt (see {@link Config.persona} for its contract). */
export interface Config {
  /** Include the fixed HiveForge Harness identity before the deployment persona (default true). */
...
<a id="hiveforge-aidsh-terminal-bash"></a>

## `@hiveforge-ai/dsh-terminal-bash`
...
<a id="hiveforge-aidsh-time-context"></a>

## `@hiveforge-ai/dsh-time-context`
...
<a id="hiveforge-aidsh-tmux-context"></a>

## `@hiveforge-ai/dsh-tmux-context`
...
<a id="hiveforge-aidsh-token-meter"></a>

## `@hiveforge-ai/dsh-token-meter`
...
<a id="hiveforge-aidsh-tool-bash"></a>

## `@hiveforge-ai/dsh-tool-bash`
...
<a id="hiveforge-aidsh-tool-bash-persistent"></a>

## `@hiveforge-ai/dsh-tool-bash-persistent`
...
<a id="hiveforge-aidsh-tool-fs"></a>

## `@hiveforge-ai/dsh-tool-fs`
...
<a id="hiveforge-aidsh-tool-fs-search"></a>

## `@hiveforge-ai/dsh-tool-fs-search`
...
<a id="hiveforge-aidsh-tool-goal"></a>
...
<a id="hiveforge-aidsh-tool-jobs"></a>

## `@hiveforge-ai/dsh-tool-jobs`
...
<a id="hiveforge-aidsh-tool-lsp"></a>

## `@hiveforge-ai/dsh-tool-lsp`
...
<a id="hiveforge-aidsh-tool-pwsh"></a>

## `@hiveforge-ai/dsh-tool-pwsh`
...
<a id="hiveforge-aidsh-tool-pwsh-persistent"></a>

## `@hiveforge-ai/dsh-tool-pwsh-persistent`
...
<a id="hiveforge-aidsh-tool-ralph"></a>

## `@hiveforge-ai/dsh-tool-ralph`
...
<a id="hiveforge-aidsh-tool-session-query"></a>

## `@hiveforge-ai/dsh-tool-session-query`
...
<a id="hiveforge-aidsh-tool-skill"></a>

## `@hiveforge-ai/dsh-tool-skill`
...
<a id="hiveforge-aidsh-tool-str-replace-editor"></a>

## `@hiveforge-ai/dsh-tool-str-replace-editor`
...
<a id="hiveforge-aidsh-tool-subagent"></a>

## `@hiveforge-ai/dsh-tool-subagent`
...
<a id="hiveforge-aidsh-tool-subagent-report"></a>

## `@hiveforge-ai/dsh-tool-subagent-report`
...
<a id="hiveforge-aidsh-tool-terminal"></a>

## `@hiveforge-ai/dsh-tool-terminal`
...
<a id="hiveforge-aidsh-tool-todo"></a>

## `@hiveforge-ai/dsh-tool-todo`
...
<a id="hiveforge-aidsh-tool-web"></a>

## `@hiveforge-ai/dsh-tool-web`
...
<a id="hiveforge-aidsh-tool-workflow"></a>

## `@hiveforge-ai/dsh-tool-workflow`
...
<a id="hiveforge-aidsh-tools"></a>

## `@hiveforge-ai/dsh-tools`
...
<a id="hiveforge-aidsh-typert-loader"></a>
...
<a id="hiveforge-aidsh-user-approval"></a>

## `@hiveforge-ai/dsh-user-approval`
...
<a id="hiveforge-aidsh-web-app"></a>
...
<a id="hiveforge-aidsh-web-fetch-http"></a>

## `@hiveforge-ai/dsh-web-fetch-http`
...
<a id="hiveforge-aidsh-web-search-hiveforge"></a>

## `@hiveforge-ai/dsh-web-search-hiveforge`
...
来源：[`packages/web/web-search-hiveforge/src/index.ts:46`](../packages/web/web-search-hiveforge/src/index.ts)

<a id="hiveforge-aidsh-web-search-exa"></a>

## `@hiveforge-ai/dsh-web-search-exa`
...
<a id="hiveforge-aidsh-web-search-perplexity"></a>

## `@hiveforge-ai/dsh-web-search-perplexity`
...
<a id="hiveforge-aidsh-workflow-worker-thread"></a>

## `@hiveforge-ai/dsh-workflow-worker-thread`
...
- `@hiveforge-ai/dsh-agent`（[`packages/core/agent/src/index.ts`](../packages/core/agent/src/index.ts)）
- `@hiveforge-ai/dsh-api-gateway` — 需要 `typert`（[`packages/api/gateway/src/index.ts`](../packages/api/gateway/src/index.ts)）
- `@hiveforge-ai/dsh-api-remotes`（[`packages/api/remotes/src/index.ts`](../packages/api/remotes/src/index.ts)）
- `@hiveforge-ai/dsh-authorization` — 需要 `credentials`（[`packages/credentials/authorization/src/index.ts`](../packages/credentials/authorization/src/index.ts)）
- `@hiveforge-ai/dsh-client-locale`（[`packages/client/locale/src/index.ts`](../packages/client/locale/src/index.ts)）
- `@hiveforge-ai/dsh-client-modules` — 需要 `webServer` · `loader`（[`packages/client/modules/src/index.ts`](../packages/client/modules/src/index.ts)）
- `@hiveforge-ai/dsh-client-runtime`（[`packages/client/runtime/src/index.ts`](../packages/client/runtime/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-agent-preset`（[`packages/client/ui-agent-preset/src/index.ts`](../packages/client/ui-agent-preset/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-attachment`（[`packages/client/ui-attachment/src/index.ts`](../packages/client/ui-attachment/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-brand-official`（[`packages/client/ui-brand-official/src/index.ts`](../packages/client/ui-brand-official/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-commands`（[`packages/client/ui-commands/src/index.ts`](../packages/client/ui-commands/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-conversation`（[`packages/client/ui-conversation/src/index.ts`](../packages/client/ui-conversation/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-cordis`（[`packages/extensions/ui-cordis/src/index.ts`](../packages/extensions/ui-cordis/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-deliverables` — 需要 `systemPrompt`（[`packages/client/ui-deliverables/src/index.ts`](../packages/client/ui-deliverables/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-directory-picker-browse`（[`packages/client/ui-directory-picker-browse/src/index.ts`](../packages/client/ui-directory-picker-browse/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-directory-picker-native`（[`packages/client/ui-directory-picker-native/src/index.ts`](../packages/client/ui-directory-picker-native/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-goal`（[`packages/client/ui-goal/src/index.ts`](../packages/client/ui-goal/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-input-trigger`（[`packages/client/ui-input-trigger/src/index.ts`](../packages/client/ui-input-trigger/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-jobs`（[`packages/client/ui-jobs/src/index.ts`](../packages/client/ui-jobs/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-layout`（[`packages/client/ui-layout/src/index.ts`](../packages/client/ui-layout/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-message-feedback`（[`packages/client/ui-message-feedback/src/index.ts`](../packages/client/ui-message-feedback/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-model-selection`（[`packages/client/ui-model-selection/src/index.ts`](../packages/client/ui-model-selection/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-permission-presets`（[`packages/client/ui-permission-presets/src/index.ts`](../packages/client/ui-permission-presets/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-plan`（[`packages/client/ui-plan/src/index.ts`](../packages/client/ui-plan/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-reference`（[`packages/client/ui-reference/src/index.ts`](../packages/client/ui-reference/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-renderer`（[`packages/client/ui-renderer/src/index.ts`](../packages/client/ui-renderer/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-settings`（[`packages/client/ui-settings/src/index.ts`](../packages/client/ui-settings/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-settings-general`（[`packages/client/ui-settings-general/src/index.ts`](../packages/client/ui-settings-general/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-settings-models`（[`packages/client/ui-settings-models/src/index.ts`](../packages/client/ui-settings-models/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-settings-plugin-inventory`（[`packages/client/ui-settings-plugin-inventory/src/index.ts`](../packages/client/ui-settings-plugin-inventory/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-settings-plugins`（[`packages/client/ui-settings-plugins/src/index.ts`](../packages/client/ui-settings-plugins/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-sidebar`（[`packages/client/ui-sidebar/src/index.ts`](../packages/client/ui-sidebar/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-skill`（[`packages/client/ui-skill/src/index.ts`](../packages/client/ui-skill/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-subagent`（[`packages/client/ui-subagent/src/index.ts`](../packages/client/ui-subagent/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-theme`（[`packages/client/ui-theme/src/index.ts`](../packages/client/ui-theme/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-tool`（[`packages/client/ui-tool/src/index.ts`](../packages/client/ui-tool/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-trajectory`（[`packages/client/ui-trajectory/src/index.ts`](../packages/client/ui-trajectory/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-user-questions`（[`packages/client/ui-user-questions/src/index.ts`](../packages/client/ui-user-questions/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-workflow-run`（[`packages/client/ui-workflow-run/src/index.ts`](../packages/client/ui-workflow-run/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-workspace`（[`packages/client/ui-workspace/src/index.ts`](../packages/client/ui-workspace/src/index.ts)）
- `@hiveforge-ai/dsh-command-compact` — 需要 `commands` · `compact`（[`packages/compaction/command-compact/src/index.ts`](../packages/compaction/command-compact/src/index.ts)）
- `@hiveforge-ai/dsh-command-feedback` — 需要 `commands`（[`packages/feedback/command-feedback/src/index.ts`](../packages/feedback/command-feedback/src/index.ts)）
- `@hiveforge-ai/dsh-command-goal` — 需要 `commands` · `goals`（[`packages/goal/command-goal/src/index.ts`](../packages/goal/command-goal/src/index.ts)）
- `@hiveforge-ai/dsh-commands`（[`packages/interaction/commands/src/index.ts`](../packages/interaction/commands/src/index.ts)）
- `@hiveforge-ai/dsh-cordis-client-runner`（[`packages/extensions/cordis-client-runner/src/index.ts`](../packages/extensions/cordis-client-runner/src/index.ts)）
- `@hiveforge-ai/dsh-fs-e2b` — 需要 `e2b`（[`packages/e2b/fs-e2b/src/index.ts`](../packages/e2b/fs-e2b/src/index.ts)）
- `@hiveforge-ai/dsh-fs-observation-policy`（[`packages/fs/fs-observation-policy/src/index.ts`](../packages/fs/fs-observation-policy/src/index.ts)）
- `@hiveforge-ai/dsh-goal-round-driver` — 需要 `agents` · `goals` · `sessions`（[`packages/goal/goal-round-driver/src/index.ts`](../packages/goal/goal-round-driver/src/index.ts)）
- `@hiveforge-ai/dsh-host-directory-picker-auto` — 需要 `webServer` · `loader`（[`packages/host/directory-picker-auto/src/index.ts`](../packages/host/directory-picker-auto/src/index.ts)）
- `@hiveforge-ai/dsh-host-directory-picker-native`（[`packages/host/directory-picker-native/src/index.ts`](../packages/host/directory-picker-native/src/index.ts)）
- `@hiveforge-ai/dsh-host-plugin-inventory` — 需要 `loader`（[`packages/host/plugin-inventory/src/index.ts`](../packages/host/plugin-inventory/src/index.ts)）
- `@hiveforge-ai/dsh-llm`（[`packages/llm/llm/src/index.ts`](../packages/llm/llm/src/index.ts)）
- `@hiveforge-ai/dsh-lsp`（[`packages/lsp/lsp/src/index.ts`](../packages/lsp/lsp/src/index.ts)）
- `@hiveforge-ai/dsh-schedule` — 需要 `agents` · `sessions` · `tools` · `sessionPersistence`（[`packages/schedule/schedule/src/index.ts`](../packages/schedule/schedule/src/index.ts)）
- `@hiveforge-ai/dsh-session`（[`packages/core/session/src/index.ts`](../packages/core/session/src/index.ts)）
- `@hiveforge-ai/dsh-session-checkpoint-policy` — 需要 `llm` · `sessionPersistence` · `sessions` · `tools`（[`packages/session/session-checkpoint-policy/src/index.ts`](../packages/session/session-checkpoint-policy/src/index.ts)）
- `@hiveforge-ai/dsh-session-log-export` — 需要 `commands`（[`packages/session-query/session-log-export/src/index.ts`](../packages/session-query/session-log-export/src/index.ts)）
- `@hiveforge-ai/dsh-session-projection`（[`packages/session/session-projection/src/index.ts`](../packages/session/session-projection/src/index.ts)）
- `@hiveforge-ai/dsh-session-stats` — 需要 `sessionProjections`（[`packages/session/session-stats/src/index.ts`](../packages/session/session-stats/src/index.ts)）
- `@hiveforge-ai/dsh-skill-badge` — 需要 `skills`（[`packages/skill/skill-badge/src/index.ts`](../packages/skill/skill-badge/src/index.ts)）
- `@hiveforge-ai/dsh-storage`（[`packages/storage/storage/src/index.ts`](../packages/storage/storage/src/index.ts)）
- `@hiveforge-ai/dsh-subagent`（[`packages/subagent/subagent/src/index.ts`](../packages/subagent/subagent/src/index.ts)）
- `@hiveforge-ai/dsh-subprocess-local`（[`packages/subprocess/subprocess-local/src/index.ts`](../packages/subprocess/subprocess-local/src/index.ts)）
- `@hiveforge-ai/dsh-terminal`（[`packages/terminal/terminal/src/index.ts`](../packages/terminal/terminal/src/index.ts)）
- `@hiveforge-ai/dsh-tool-ask-user` — 需要 `tools` · `userInteraction`（[`packages/interaction/tool-ask-user/src/index.ts`](../packages/interaction/tool-ask-user/src/index.ts)）
- `@hiveforge-ai/dsh-tool-call-timeout-policy` — 需要 `tools`（[`packages/guard/timeout-policy/src/index.ts`](../packages/guard/timeout-policy/src/index.ts)）
- `@hiveforge-ai/dsh-tool-cordis` — 需要 `tools` · `systemPrompt` · `dynamicCordisRunner` · `cordisInspect`（[`packages/extensions/tool-cordis/src/index.ts`](../packages/extensions/tool-cordis/src/index.ts)）
- `@hiveforge-ai/dsh-tool-subagent-control` — 需要 `tools` · `subagents`（[`packages/subagent/tool-subagent-control/src/index.ts`](../packages/subagent/tool-subagent-control/src/index.ts)）
- `@hiveforge-ai/dsh-user-questions`（[`packages/interaction/user-questions/src/index.ts`](../packages/interaction/user-questions/src/index.ts)）
- `@hiveforge-ai/dsh-workspace` — 需要 `storageDomain` · `sessionPersistence`（[`packages/workspace/workspace/src/index.ts`](../packages/workspace/workspace/src/index.ts)）

## Seam 包（不可直接加载）

抽象服务类——部署时应改为加载具体的实现包（参见[能力 seam](../.agents/notes/implemented/architecture/2026-06-13-capability-seams.zh.md)）。

- `@hiveforge-ai/dsh-attachment` — 抽象 `AttachmentStore`（[`packages/attachment/attachment/src/index.ts`](../packages/attachment/attachment/src/index.ts)）
- `@hiveforge-ai/dsh-code-runtime` — 抽象 `CodeRuntime`（[`packages/code-runtime/code-runtime/src/index.ts`](../packages/code-runtime/code-runtime/src/index.ts)）
- `@hiveforge-ai/dsh-compaction` — 抽象 `CompactionEngine`（[`packages/compaction/compaction/src/index.ts`](../packages/compaction/compaction/src/index.ts)）
- `@hiveforge-ai/dsh-credentials` — 抽象 `Credentials`（[`packages/credentials/credentials/src/index.ts`](../packages/credentials/credentials/src/index.ts)）
- `@hiveforge-ai/dsh-file-reference` — 抽象 `FileReferenceService`（[`packages/context/file-reference/src/index.ts`](../packages/context/file-reference/src/index.ts)）
- `@hiveforge-ai/dsh-fs` — 抽象 `FileSystem`（[`packages/fs/fs/src/index.ts`](../packages/fs/fs/src/index.ts)）
- `@hiveforge-ai/dsh-host-directory-picker` — 抽象 `DirectoryPicker`（[`packages/host/directory-picker/src/index.ts`](../packages/host/directory-picker/src/index.ts)）
- `@hiveforge-ai/dsh-jobs` — 抽象 `JobRegistry`（[`packages/jobs/jobs/src/index.ts`](../packages/jobs/jobs/src/index.ts)）
- `@hiveforge-ai/dsh-sandbox` — 抽象 `SandboxProvider`（[`packages/sandbox/sandbox/src/index.ts`](../packages/sandbox/sandbox/src/index.ts)）
- `@hiveforge-ai/dsh-session-persistence` — 抽象 `SessionPersistence`（[`packages/session/session-persistence/src/index.ts`](../packages/session/session-persistence/src/index.ts)）
- `@hiveforge-ai/dsh-session-query` — 抽象 `SessionQueryEngine`（[`packages/session-query/session-query/src/index.ts`](../packages/session-query/session-query/src/index.ts)）
- `@hiveforge-ai/dsh-settings` — 抽象 `Settings`（[`packages/settings/settings/src/index.ts`](../packages/settings/settings/src/index.ts)）
- `@hiveforge-ai/dsh-shell` — 抽象 `ShellExecutor`（[`packages/shell/shell/src/index.ts`](../packages/shell/shell/src/index.ts)）
- `@hiveforge-ai/dsh-spill` — 抽象 `SpillStore`（[`packages/spill/spill/src/index.ts`](../packages/spill/spill/src/index.ts)）
- `@hiveforge-ai/dsh-subprocess` — 抽象 `SubprocessRuntime`（[`packages/subprocess/subprocess/src/index.ts`](../packages/subprocess/subprocess/src/index.ts)）
- `@hiveforge-ai/dsh-workflow` — 抽象 `WorkflowEngine`（[`packages/workflow/workflow/src/index.ts`](../packages/workflow/workflow/src/index.ts)）
## 库包（无插件入口）

由其他包作为库导入；`cordis.yml` 无法加载它们。

- `@hiveforge-ai/dsh-acp-snapshot`（[`packages/test-support/acp-snapshot/src/index.ts`](../packages/test-support/acp-snapshot/src/index.ts)）
- `@hiveforge-ai/dsh-agent-loop-testkit`（[`packages/test-support/agent-loop-testkit/src/index.ts`](../packages/test-support/agent-loop-testkit/src/index.ts)）
- `@hiveforge-ai/dsh-anonymous-user-id`（[`packages/identity/anonymous-user-id/src/index.ts`](../packages/identity/anonymous-user-id/src/index.ts)）
- `@hiveforge-ai/dsh-app-boot`（[`packages/boot/app-boot/src/index.ts`](../packages/boot/app-boot/src/index.ts)）
- `@hiveforge-ai/dsh-atomic-write`（[`packages/util/atomic-write/src/index.ts`](../packages/util/atomic-write/src/index.ts)）
- `@hiveforge-ai/dsh-base`（[`packages/bundle/base/src/index.ts`](../packages/bundle/base/src/index.ts)）
- `@hiveforge-ai/dsh-brand`（[`packages/util/brand/src/index.ts`](../packages/util/brand/src/index.ts)）
- `@hiveforge-ai/dsh-client-test-runtime`（[`packages/test-support/client-runtime/src/index.ts`](../packages/test-support/client-runtime/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-primitives`（[`packages/client/ui-primitives/src/index.ts`](../packages/client/ui-primitives/src/index.ts)）
- `@hiveforge-ai/dsh-client-ui-slots`（[`packages/client/ui-slots/src/index.ts`](../packages/client/ui-slots/src/index.ts)）
- `@hiveforge-ai/dsh-client-web`（[`packages/client/web/src/index.ts`](../packages/client/web/src/index.ts)）
- `@hiveforge-ai/dsh-cmdline`（[`packages/boot/cmdline/src/index.ts`](../packages/boot/cmdline/src/index.ts)）
- `@hiveforge-ai/dsh-code-runtime-python`（[`packages/code-runtime/code-runtime-python/src/index.ts`](../packages/code-runtime/code-runtime-python/src/index.ts)）
- `@hiveforge-ai/dsh-home-paths`（[`packages/util/home-paths/src/index.ts`](../packages/util/home-paths/src/index.ts)）
- `@hiveforge-ai/dsh-hook-protocol`（[`packages/hooks/hook-protocol/src/index.ts`](../packages/hooks/hook-protocol/src/index.ts)）
- `@hiveforge-ai/dsh-launch-environment`（[`packages/util/launch-environment/src/index.ts`](../packages/util/launch-environment/src/index.ts)）
- `@hiveforge-ai/dsh-llm-mock-server`（[`packages/test-support/llm-mock-server/src/index.ts`](../packages/test-support/llm-mock-server/src/index.ts)）
- `@hiveforge-ai/dsh-loader-smoke`（[`packages/test-support/loader-smoke/src/index.ts`](../packages/test-support/loader-smoke/src/index.ts)）
- `@hiveforge-ai/dsh-native-command`（[`packages/util/native-command/src/index.ts`](../packages/util/native-command/src/index.ts)）
- `@hiveforge-ai/dsh-output-retention`（[`packages/util/output-retention/src/index.ts`](../packages/util/output-retention/src/index.ts)）
- `@hiveforge-ai/dsh-sandbox-windows-acl`（[`packages/sandbox/sandbox-windows-acl/src/index.ts`](../packages/sandbox/sandbox-windows-acl/src/index.ts)）
- `@hiveforge-ai/dsh-scope`（[`packages/core/scope/src/index.ts`](../packages/core/scope/src/index.ts)）
- `@hiveforge-ai/dsh-sdk-client`（[`packages/sdk/client/src/index.ts`](../packages/sdk/client/src/index.ts)）
- `@hiveforge-ai/dsh-sdk-jsonrpc-demo`（[`packages/examples/jsonrpc-demo/src/index.ts`](../packages/examples/jsonrpc-demo/src/index.ts)）
- `@hiveforge-ai/dsh-sdk-protocol`（[`packages/sdk/protocol/src/index.ts`](../packages/sdk/protocol/src/index.ts)）
- `@hiveforge-ai/dsh-session-telemetry`（[`packages/session/session-telemetry/src/index.ts`](../packages/session/session-telemetry/src/index.ts)）
- `@hiveforge-ai/dsh-session-title-llm`（[`packages/session/session-title-llm/src/index.ts`](../packages/session/session-title-llm/src/index.ts)）
- `@hiveforge-ai/dsh-subagent-in-process-driver`（[`packages/subagent/subagent-in-process-driver/src/index.ts`](../packages/subagent/subagent-in-process-driver/src/index.ts)）
- `@hiveforge-ai/dsh-timeout`（[`packages/util/timeout/src/index.ts`](../packages/util/timeout/src/index.ts)）
- `@hiveforge-ai/dsh-typert-generator`（[`packages/typert/generator/src/index.ts`](../packages/typert/generator/src/index.ts)）
- `@hiveforge-ai/dsh-typert-protocol`（[`packages/typert/protocol/src/index.ts`](../packages/typert/protocol/src/index.ts)）
- `@hiveforge-ai/dsh-typert-registry`（[`packages/typert/registry/src/index.ts`](../packages/typert/registry/src/index.ts)）
