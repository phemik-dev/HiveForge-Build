...
import type {} from '@hiveforge-ai/dsh-client-ui-settings-plugins/client'
...
```jsonc
{
  ...
  "dsh": { "client": { "platform": "web", "inject": ["@hiveforge-ai/dsh-client-ui-settings-plugins"] } }
}
```
...
export default clientBundle('@hiveforge-ai/dsh-client-my-plugin', ['lib/types/index.js', 'lib/types/invariant.js'])
```
