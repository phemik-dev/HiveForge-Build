...
import { MyCapService, type MyCapRequest, type MyCapResult } from '@hiveforge-ai/dsh-my-cap'
...
```yaml
- name: '@hiveforge-ai/dsh-my-cap-local'
- name: '@hiveforge-ai/dsh-tool-my-cap'
```
