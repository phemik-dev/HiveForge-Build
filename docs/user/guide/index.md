...
Open **Settings → Models**, enter a [HiveForge API key](https://platform.hiveforge.com/), and save it. The model route becomes usable immediately without restarting the server.
