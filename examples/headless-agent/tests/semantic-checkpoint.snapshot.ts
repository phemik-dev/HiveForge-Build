...
import { normalizeSessionSnapshot, type NormalizeContext } from '@hiveforge-ai/dsh-acp-snapshot'
...
import SessionStore, { SESSION_FORMAT_VERSION, SessionId, type SessionEvent, type SessionHeader } from '@hiveforge-ai/dsh-session'
