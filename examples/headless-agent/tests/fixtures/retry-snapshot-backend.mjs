 ...
 * @param {import('@hiveforge-ai/cordis').Context} ctx - plugin context carrying the LLM service.
 */
export function apply(ctx) {
  ctx.llm.registerAdapter(['hiveforge-official'], new RetrySnapshotAdapter())
}
